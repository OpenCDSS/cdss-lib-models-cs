...
namespace DWR.StateMod
{
	...
	/// </summary>
	public class StateMod_WellRight_TableModel : JWorksheet_AbstractRowTableModel
	{
	...
	/// </summary>
	public const int COL_WELL_ID = -1, COL_RIGHT_ID = 0, COL_RIGHT_NAME = 1, COL_STRUCT_ID = 2, COL_ADMIN_NUM = 3, COL_DCR_AMT = 4, COL_ON_OFF = 5, COL_PARCEL_YEAR = 6, COL_PARCEL_CLASS = 7, COL_PARCEL_ID = 8, COL_COLLECTION_TYPE = 9, COL_COLLECTION_PART_TYPE = 10, COL_COLLECTION_PART_ID = 11, COL_COLLECTION_PART_ID_TYPE = 12, COL_X_RIGHT_WDID = 13, COL_X_RIGHT_APPROPRIATION_DATE = 14, COL_X_RIGHT_ADMIN_NUMBER = 15, COL_X_PERMIT_RECEIPT = 16, COL_X_PERMIT_DATE = 17, COL_X_PERMIT_ADMIN_NUMBER = 18, COL_X_WELL_YIELD_GPM = 19, COL_X_WELL_YIELD_CFS = 20, COL_X_APEX_GPM = 21, COL_X_APEX_CFS = 22, COL_X_WELL_FRACTION = 23, COL_X_DITCH_FRACTION = 24, COL_X_YIELD_PRORATED_GPM = 25;
	...
	/// </summary>
	private bool __singleWell = true;
	...
	/// <param name="singleWell"> if true, then the table model is set up to only display
	/// a single well's right data.  This means that the well ID field will
	/// not be shown.  If false then the well right field will be included. </param>
	/// <exception cref="Exception"> if an invalid data or dmi was passed in. </exception>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public StateMod_WellRight_TableModel(java.util.List data, boolean editable, boolean singleWell) throws Exception
	public StateMod_WellRight_TableModel(System.Collections.IList data, bool editable, bool singleWell)
	{
		if (data == null)
		{
	...
	/// well station window and maintaining agreement between the two windows. </summary>
	/// <param name="rowIndex"> unused. </param>
	/// <param name="col"> the index of the column to check whether it is editable or not. </param>
