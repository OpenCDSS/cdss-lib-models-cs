// StateMod_ReservoirClimate_Data_CellRenderer - Class for rendering cells for reservoir climate station tables
...
// ----------------------------------------------------------------------------
// StateMod_ReservoirClimate_Data_CellRenderer - Class for rendering cells for 
...
namespace DWR.StateMod
{
	...
	/// </summary>
	public class StateMod_ReservoirClimate_Data_CellRenderer : JWorksheet_AbstractExcelCellRenderer
	{

	/// <summary>
	/// Table model for which this class renders the cells.
	/// </summary>
	private StateMod_ReservoirClimate_Data_TableModel __tableModel;

	/// <summary>
	/// Constructor. </summary>
	/// <param name="tableModel"> the table model for which this class renders cells. </param>
	public StateMod_ReservoirClimate_Data_CellRenderer(StateMod_ReservoirClimate_Data_TableModel tableModel)
	{
