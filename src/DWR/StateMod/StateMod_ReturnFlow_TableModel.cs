...
namespace DWR.StateMod
{
	...
	/// and depletions.
	/// </summary>
	public class StateMod_ReturnFlow_TableModel : JWorksheet_AbstractRowTableModel
	{
...
//ORIGINAL LINE: public StateMod_ReturnFlow_TableModel(java.util.List data, boolean editable, boolean is_return) throws Exception
	public StateMod_ReturnFlow_TableModel(System.Collections.IList data, bool editable, bool is_return) : this(null, data, editable, is_return)
	{
	}
...
//ORIGINAL LINE: public StateMod_ReturnFlow_TableModel(StateMod_DataSet dataset, java.util.List data, boolean editable, boolean is_return) throws Exception
	...
	/// the worksheet is not editable. </summary>
