// StateMod_WellRight_CellRenderer - Class for rendering cells for well right tables
...
// ----------------------------------------------------------------------------
// StateMod_WellRight_CellRenderer - Class for rendering cells for well right
//	tables
// ----------------------------------------------------------------------------
...
// 2004-10-28	Steven A. Malers, RTi	Split out of StateMod_Well_CellRenderer.
// ----------------------------------------------------------------------------
...
//ORIGINAL LINE: @SuppressWarnings("serial") public class StateMod_WellRight_CellRenderer extends RTi.Util.GUI.JWorksheet_AbstractExcelCellRenderer
	public class StateMod_WellRight_CellRenderer : JWorksheet_AbstractExcelCellRenderer
	{

	private StateMod_WellRight_TableModel __tableModel;

	/// <summary>
	/// Constructor. </summary>
	/// <param name="tableModel"> the table model for which to render cells </param>
	public StateMod_WellRight_CellRenderer(StateMod_WellRight_TableModel tableModel)
	{
