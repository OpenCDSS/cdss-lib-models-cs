// StateMod_ReservoirRight_Data_JFrame - JFrame that displays ReservoirRight data in a tabular format.
...
// PRINTING CHECKED
// ----------------------------------------------------------------------------
// StateMod_ReservoirRight_Data_JFrame - This is a JFrame that displays 
//	ReservoirRight data in a tabular format.
// ----------------------------------------------------------------------------
...
namespace DWR.StateMod
{
	...
	/// </summary>
	public class StateMod_ReservoirRight_Data_JFrame : StateMod_Data_JFrame
	{
...
//ORIGINAL LINE: public StateMod_ReservoirRight_Data_JFrame(java.util.List data, String titleString, boolean editable) throws Exception
	public StateMod_ReservoirRight_Data_JFrame(System.Collections.IList data, string titleString, bool editable) : base(data, titleString, editable)
	{
		setSize(750, 350);
		PRINT_PORTRAIT_LINES = 75;
...
//ORIGINAL LINE: protected RTi.Util.GUI.JScrollWorksheet buildJScrollWorksheet() throws Exception
	...
	{
		StateMod_ReservoirRight_Data_TableModel tableModel = new StateMod_ReservoirRight_Data_TableModel(_data, _editable);
		StateMod_ReservoirRight_Data_CellRenderer cellRenderer = new StateMod_ReservoirRight_Data_CellRenderer(tableModel);
