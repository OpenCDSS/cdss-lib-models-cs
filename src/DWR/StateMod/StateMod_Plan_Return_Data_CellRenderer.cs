// StateMod_Plan_Return_Data_CellRenderer - class used for rendering cells for Plan station return assignment.
...
//ORIGINAL LINE: @SuppressWarnings("serial") public class StateMod_Plan_Return_Data_CellRenderer extends RTi.Util.GUI.JWorksheet_AbstractExcelCellRenderer
	public class StateMod_Plan_Return_Data_CellRenderer : JWorksheet_AbstractExcelCellRenderer
	{

	/// <summary>
	/// The table model for which this class renders the cells.
	/// </summary>
	private StateMod_Plan_Return_Data_TableModel __tableModel;

	/// <summary>
	/// Constructor. </summary>
	/// <param name="tableModel"> the tableModel for which this will render the cells </param>
	public StateMod_Plan_Return_Data_CellRenderer(StateMod_Plan_Return_Data_TableModel tableModel)
	{
