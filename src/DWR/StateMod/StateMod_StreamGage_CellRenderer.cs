// StateMod_StreamGage_CellRenderer - Class for rendering cells for stream gage tables
...
// ----------------------------------------------------------------------------
// StateMod_StreamGage_CellRenderer - Class for rendering cells for stream gage
//					tables
// ----------------------------------------------------------------------------
...
//					StateMod_RiverStation_CellRenderer to
//					StateMod_StreamGage_CellRenderer.
// ----------------------------------------------------------------------------
...
namespace DWR.StateMod
{
	...
	/// </summary>
	public class StateMod_StreamGage_CellRenderer : JWorksheet_AbstractExcelCellRenderer
	{

	/// <summary>
	/// Table model for which this class renders the cells.
	/// </summary>
	private StateMod_StreamGage_TableModel __tableModel;

	/// <summary>
	/// Constructor. </summary>
	/// <param name="tableModel"> the table model for which this class renders cells. </param>
	public StateMod_StreamGage_CellRenderer(StateMod_StreamGage_TableModel tableModel)
	{
