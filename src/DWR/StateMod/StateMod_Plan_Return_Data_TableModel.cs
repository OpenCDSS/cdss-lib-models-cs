...
// StateMod_Plan_Return_Data_TableModel - this class displays plan station return assignment data.
...
namespace DWR.StateMod
{
	...
	/// <summary>
	/// This class displays plan station return assignment data.
	/// </summary>
	public class StateMod_Plan_Return_Data_TableModel : JWorksheet_AbstractRowTableModel, StateMod_Data_TableModel
	{
	...
	/// </summary>
	public const int COL_PLAN_ID = 0, COL_RIVER_NODE_ID = 1, COL_PERCENT_RETURN = 2, COL_DELAY_TABLE_ID = 3, COL_COMMENT = 4;
...
//ORIGINAL LINE: public StateMod_Plan_Return_Data_TableModel(java.util.List data, boolean editable) throws Exception
	public StateMod_Plan_Return_Data_TableModel(System.Collections.IList data, bool editable)
	{
		if (data == null)
		{
