...
namespace DWR.StateMod
{
	...
	/// </summary>
	public class StateMod_Diversion_Data_JFrame : StateMod_Data_JFrame
	{
...
//ORIGINAL LINE: public StateMod_Diversion_Data_JFrame(java.util.List data, String titleString, boolean editable) throws Exception
	public StateMod_Diversion_Data_JFrame(System.Collections.IList data, string titleString, bool editable) : base(data, titleString, editable)
	{
