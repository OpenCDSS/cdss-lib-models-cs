// StateMod_StreamEstimate_Data_CellRenderer - Class for rendering cells for stream estimate station-related tables
...
// ----------------------------------------------------------------------------
// StateMod_StreamEstimate_Data_CellRenderer - Class for rendering cells for 
...
namespace DWR.StateMod
{
	...
	/// </summary>
	public class StateMod_StreamEstimate_Data_CellRenderer : JWorksheet_AbstractExcelCellRenderer
	{

	/// <summary>
	/// Table model for which this class renders the cells.
	/// </summary>
	private StateMod_StreamEstimate_Data_TableModel __tableModel;
