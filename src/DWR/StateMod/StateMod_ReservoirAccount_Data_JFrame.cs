...
namespace DWR.StateMod
{
	...
	/// </summary>
	public class StateMod_ReservoirAccount_Data_JFrame : StateMod_Data_JFrame
	{
...
//ORIGINAL LINE: protected RTi.Util.GUI.JScrollWorksheet buildJScrollWorksheet() throws Exception
	...
	{
		StateMod_ReservoirAccount_Data_TableModel tableModel = new StateMod_ReservoirAccount_Data_TableModel(_data, _editable);
		StateMod_ReservoirAccount_Data_CellRenderer cellRenderer = new StateMod_ReservoirAccount_Data_CellRenderer(tableModel);
