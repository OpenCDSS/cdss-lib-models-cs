...
//		base.finalize();
                    ...
                    */
                    ...
                    if (fileHasExtendedComments)
                    {
                        try
                        {
                            ...
                            aRight.setXYieldGPM((double)v[20]);
                            aRight.setXYieldApexGPM((double)v[21]);
                            aRight.setXFractionYield((double)v[22]);
                            aRight.setXDitchFraction((double)v[23]);
                            aRight.setXProratedYield((double)v[24]);
                        }
                        catch (Exception e)
                        {
	...
	public virtual void setDcrdivw(string dcrdivw)
	{
		...
		setDcrdivw(double.Parse(dcrdivw.Trim()));
	}
