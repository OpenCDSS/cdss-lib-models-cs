...
namespace DWR.StateMod
{
	...
	{
		IList<string> specialChoices = new List<string>();
		int rightTypeNumber = getRightTypeNumber();
	...
	public virtual bool getRightTypeUsesMonthlyOprEff(StateMod_DataSet dataSet, string source2, string sourceAccount2)
	{
		...
		int pos = StateMod_Util.indexOf((System.Collections.IList)planList, source2);
		if (pos >= 0)
		{
	...
	private static void initialize()
	{
		...
		__opRightsMetadataList = new List<StateMod_OperationalRight_Metadata>();
