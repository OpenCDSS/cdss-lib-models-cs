...
// StateMod_Plan_WellAugmentation_Data_JFrame - This class is a JFrame for displaying a list of well augmentation plan data in a worksheet.
...
//ORIGINAL LINE: @SuppressWarnings("serial") public class StateMod_Plan_WellAugmentation_Data_JFrame extends StateMod_Data_JFrame
	public class StateMod_Plan_WellAugmentation_Data_JFrame : StateMod_Data_JFrame
	{
...
//ORIGINAL LINE: public StateMod_Plan_WellAugmentation_Data_JFrame(java.util.List<StateMod_Plan_WellAugmentation> data, String titleString, boolean editable) throws Exception
	public StateMod_Plan_WellAugmentation_Data_JFrame(IList<StateMod_Plan_WellAugmentation> data, string titleString, bool editable) : base()
	{
