...
namespace DWR.StateMod
{
	...
	/// </summary>
	public class StateMod_DiversionRight_Data_JFrame : StateMod_Data_JFrame
	{
	...
	/// <param name="titleString"> the String to put in the title of the GUI. </param>
...
//ORIGINAL LINE: public StateMod_DiversionRight_Data_JFrame(java.util.List data, String titleString, boolean editable) throws Exception
	public StateMod_DiversionRight_Data_JFrame(System.Collections.IList data, string titleString, bool editable) : base(data, titleString, editable)
	{
...
//ORIGINAL LINE: protected RTi.Util.GUI.JScrollWorksheet buildJScrollWorksheet() throws Exception
	...
	{
		StateMod_DiversionRight_Data_TableModel tableModel = new StateMod_DiversionRight_Data_TableModel(_data, _editable);
			// false means to set up the table model to allow 1+
			// diversions' rights to be in the same worksheet.
		StateMod_DiversionRight_Data_CellRenderer cellRenderer = new StateMod_DiversionRight_Data_CellRenderer(tableModel);
