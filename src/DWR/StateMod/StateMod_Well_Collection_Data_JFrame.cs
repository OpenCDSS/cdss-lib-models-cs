...
//ORIGINAL LINE: @SuppressWarnings("serial") public class StateMod_Well_Collection_Data_JFrame extends StateMod_Data_JFrame
	public class StateMod_Well_Collection_Data_JFrame : StateMod_Data_JFrame
	{
...
//ORIGINAL LINE: public StateMod_Well_Collection_Data_JFrame(java.util.List<StateMod_Well> data, String titleString, boolean editable) throws Exception
	public StateMod_Well_Collection_Data_JFrame(IList<StateMod_Well> data, string titleString, bool editable) : base(data, titleString, editable)
	{
...
//ORIGINAL LINE: protected RTi.Util.GUI.JScrollWorksheet buildJScrollWorksheet() throws Exception
	...
	{
		StateMod_Well_Collection_Data_TableModel tableModel = new StateMod_Well_Collection_Data_TableModel(_data, _editable);
		StateMod_Well_Collection_Data_CellRenderer cellRenderer = new StateMod_Well_Collection_Data_CellRenderer(tableModel);
