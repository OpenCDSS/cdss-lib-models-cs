// StateCU_ComponentValidationProblem - Simple class to hold validation problem for a StateCU component object
...
{
	/// <summary>
	/// Simple class to hold validation problem for a StateCU component object, including the object reference,
	/// the problem description, and the recommendation to fix.
	/// </summary>
	public class StateCU_ComponentValidationProblem
	{

	/// <summary>
	/// Object that has the problem.
	/// </summary>
	private StateCU_ComponentValidator __data;
	...
	/// </summary>
	public virtual StateCU_ComponentValidator getData()
	{
		return __data;
	}
