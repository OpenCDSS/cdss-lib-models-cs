...
//ORIGINAL LINE: @SuppressWarnings("serial") public class StateCU_Location_Collection_Data_JFrame extends DWR.StateMod.StateMod_Data_JFrame
	public class StateCU_Location_Collection_Data_JFrame : StateMod_Data_JFrame
	{
...
//ORIGINAL LINE: public StateCU_Location_Collection_Data_JFrame(java.util.List<StateCU_Location> data, String titleString, boolean editable) throws Exception
	public StateCU_Location_Collection_Data_JFrame(IList<StateCU_Location> data, string titleString, bool editable) : base(data, titleString, editable)
	{
...
//ORIGINAL LINE: protected RTi.Util.GUI.JScrollWorksheet buildJScrollWorksheet() throws Exception
	protected internal override JScrollWorksheet buildJScrollWorksheet()
	{
		...
		StateCU_Location_Collection_CellRenderer cellRenderer = new StateCU_Location_Collection_CellRenderer(tableModel);
