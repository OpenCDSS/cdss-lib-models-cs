...
//ORIGINAL LINE: @SuppressWarnings("serial") public class StateCU_DataSetComponent_CellRenderer extends RTi.Util.GUI.JWorksheet_DefaultTableCellRenderer
	public class StateCU_DataSetComponent_CellRenderer : JWorksheet_DefaultTableCellRenderer
	{

	internal StateCU_DataSetComponent_TableModel __table_model = null; // Table model
									// to render

	/// <summary>
	/// Constructor. </summary>
	/// <param name="table_model"> The StateCU_DataSetComponent_TableModel to render. </param>
	public StateCU_DataSetComponent_CellRenderer(StateCU_DataSetComponent_TableModel table_model)
	{
