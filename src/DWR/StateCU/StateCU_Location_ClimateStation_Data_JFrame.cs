...
// StateCU_Location_ClimateStation_Data_JFrame - JFrame that displays location climate station data in a tabular format.
...
// PRINTING CHECKED
// ----------------------------------------------------------------------------
// StateCU_Location_ClimateStation_Data_JFrame - This is a JFrame that 
//	displays location climate station data in a tabular format.
// ----------------------------------------------------------------------------
...
namespace DWR.StateCU
{
	...
	/// climate station data in a worksheet.  The worksheet data can be exported to a file or printed.
	/// </summary>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @SuppressWarnings("serial") public class StateCU_Location_ClimateStation_Data_JFrame extends DWR.StateMod.StateMod_Data_JFrame
	public class StateCU_Location_ClimateStation_Data_JFrame : StateMod_Data_JFrame
	{
...
//ORIGINAL LINE: public StateCU_Location_ClimateStation_Data_JFrame(java.util.List<StateCU_Location> data, String titleString, boolean editable) throws Exception
	public StateCU_Location_ClimateStation_Data_JFrame(IList<StateCU_Location> data, string titleString, bool editable) : base(data, titleString, editable)
	{
	...
	protected internal override void apply()
	{
		...
		{
			station = (StateCU_Location)_data[i];
...
//ORIGINAL LINE: protected RTi.Util.GUI.JScrollWorksheet buildJScrollWorksheet() throws Exception
	...
	{
		StateCU_Location_ClimateStation_TableModel tableModel = new StateCU_Location_ClimateStation_TableModel(_data, _editable);
		StateCU_Location_ClimateStation_CellRenderer cellRenderer = new StateCU_Location_ClimateStation_CellRenderer(tableModel);
