...
// StateCU_CropCharacteristics_Data_JFrame - JFrame that displays CropCharacteristics data in a tabular format
...
//ORIGINAL LINE: @SuppressWarnings("serial") public class StateCU_CropCharacteristics_Data_JFrame extends DWR.StateMod.StateMod_Data_JFrame
	public class StateCU_CropCharacteristics_Data_JFrame : StateMod_Data_JFrame
	{
...
//ORIGINAL LINE: public StateCU_CropCharacteristics_Data_JFrame(java.util.List<StateCU_CropCharacteristics> data, String titleString, boolean editable) throws Exception
	public StateCU_CropCharacteristics_Data_JFrame(IList<StateCU_CropCharacteristics> data, string titleString, bool editable) : base(data, titleString, editable)
	{
...
//ORIGINAL LINE: protected RTi.Util.GUI.JScrollWorksheet buildJScrollWorksheet() throws Exception
	...
	{
		StateCU_CropCharacteristics_TableModel tableModel = new StateCU_CropCharacteristics_TableModel(_data, _editable, false);
		StateCU_CropCharacteristics_CellRenderer cellRenderer = new StateCU_CropCharacteristics_CellRenderer(tableModel);
