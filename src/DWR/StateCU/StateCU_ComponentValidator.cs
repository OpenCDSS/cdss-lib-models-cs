// StateCU_ComponentValidator - this interface should be implemented by StateCU
// data object classes and provides validation within a dataset.
...
namespace DWR.StateCU
{
	...
	public interface StateCU_ComponentValidator
	{
		...
		/// to fully check one component may require checking other components. </summary>
		/// <param name="dataset"> the StateMod_DataSet that is managing the individual object.  If null, do not
		/// perform dataset checks. </param>
