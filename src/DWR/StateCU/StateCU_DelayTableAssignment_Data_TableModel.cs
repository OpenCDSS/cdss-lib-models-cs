...
// StateCU_DelayTableAssignment_Data_TableModel - table model for displaying data for delay table assignment worksheets.
...
namespace DWR.StateCU
{
	...
	/// </summary>
	public class StateCU_DelayTableAssignment_Data_TableModel : JWorksheet_AbstractRowTableModel, StateCU_Data_TableModel
	{
	...
	/// Columns
	/// </summary>
	private readonly int __COL_ID = 0, __COL_DELAY_ID = 1, __COL_PERCENT = 2;
	...
	public StateCU_DelayTableAssignment_Data_TableModel(System.Collections.IList data) : this(data, true)
	{
	}
	...
	public StateCU_DelayTableAssignment_Data_TableModel(System.Collections.IList data, bool editable)
	{
		if (data == null)
		{
