...
// StateCU_Location_Data_JFrame - JFrame that displays Location data in a tabular format.
...
//ORIGINAL LINE: @SuppressWarnings("serial") public class StateCU_Location_Data_JFrame extends DWR.StateMod.StateMod_Data_JFrame
	public class StateCU_Location_Data_JFrame : StateMod_Data_JFrame
	{
...
//ORIGINAL LINE: public StateCU_Location_Data_JFrame(java.util.List<StateCU_Location> data, String titleString, boolean editable) throws Exception
	public StateCU_Location_Data_JFrame(IList<StateCU_Location> data, string titleString, bool editable) : base(data, titleString, editable)
	{
