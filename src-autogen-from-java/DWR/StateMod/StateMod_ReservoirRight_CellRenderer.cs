...
namespace DWR.StateMod
{
	...
	/// </summary>
	public class StateMod_ReservoirRight_CellRenderer : JWorksheet_AbstractExcelCellRenderer
	{
	...
	public StateMod_ReservoirRight_CellRenderer(StateMod_ReservoirRight_TableModel tableModel)
	{
