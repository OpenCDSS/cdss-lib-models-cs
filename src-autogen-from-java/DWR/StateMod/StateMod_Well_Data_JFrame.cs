...
// StateMod_Well_Data_JFrame - JFrame that displays Well data in a tabular format.
...
//ORIGINAL LINE: @SuppressWarnings("serial") public class StateMod_Well_Data_JFrame extends StateMod_Data_JFrame
	public class StateMod_Well_Data_JFrame : StateMod_Data_JFrame
	{
...
//ORIGINAL LINE: public StateMod_Well_Data_JFrame(java.util.List<StateMod_Well> data, String titleString, boolean editable) throws Exception
	public StateMod_Well_Data_JFrame(IList<StateMod_Well> data, string titleString, bool editable) : base(data, titleString, editable)
	{
