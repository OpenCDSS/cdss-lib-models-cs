// StateMod_InstreamFlow_Data_JFrame - JFrame that displays InstreamFlow data in a tabular format.
...
namespace DWR.StateMod
{
	...
	/// </summary>
	public class StateMod_InstreamFlow_Data_JFrame : StateMod_Data_JFrame
	{
...
//ORIGINAL LINE: public StateMod_InstreamFlow_Data_JFrame(java.util.List data, String titleString, boolean editable) throws Exception
	public StateMod_InstreamFlow_Data_JFrame(System.Collections.IList data, string titleString, bool editable) : base(data, titleString, editable)
	{
...
//ORIGINAL LINE: protected RTi.Util.GUI.JScrollWorksheet buildJScrollWorksheet() throws Exception
	...
	{
		StateMod_InstreamFlow_Data_TableModel tableModel = new StateMod_InstreamFlow_Data_TableModel(_data, _editable);
		StateMod_InstreamFlow_Data_CellRenderer cellRenderer = new StateMod_InstreamFlow_Data_CellRenderer(tableModel);
