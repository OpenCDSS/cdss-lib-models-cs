// StateMod_InstreamFlow_CellRenderer - Class for rending data for instream flow station tables
...
// ----------------------------------------------------------------------------
// StateMod_InstreamFlow_CellRenderer - Class for rending data for 
...
namespace DWR.StateMod
{
	...
	/// </summary>
	public class StateMod_InstreamFlow_CellRenderer : JWorksheet_AbstractExcelCellRenderer
	{

	/// <summary>
	/// Table model for which this class renders cells.
	/// </summary>
	private StateMod_InstreamFlow_TableModel __tableModel;

	/// <summary>
	/// Constructor. </summary>
	/// <param name="tableModel"> the table model for which this class renders cells. </param>
	public StateMod_InstreamFlow_CellRenderer(StateMod_InstreamFlow_TableModel tableModel)
	{
