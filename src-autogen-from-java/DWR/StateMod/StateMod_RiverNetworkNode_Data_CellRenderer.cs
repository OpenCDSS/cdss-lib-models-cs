// StateMod_RiverNetworkNode_Data_CellRenderer - Class for rendering cells for reservoir-related tables
...
// ----------------------------------------------------------------------------
// StateMod_RiverNetworkNode_Data_CellRenderer - Class for rendering cells for 
...
namespace DWR.StateMod
{
	...
	/// </summary>
	public class StateMod_RiverNetworkNode_Data_CellRenderer : JWorksheet_AbstractExcelCellRenderer
	{

	/// <summary>
	/// Table model for which this class renders the cells.
	/// </summary>
	private StateMod_RiverNetworkNode_Data_TableModel __tableModel;

	/// <summary>
	/// Constructor. </summary>
	/// <param name="tableModel"> the table model for which this class renders cells. </param>
	public StateMod_RiverNetworkNode_Data_CellRenderer(StateMod_RiverNetworkNode_Data_TableModel tableModel)
	{
