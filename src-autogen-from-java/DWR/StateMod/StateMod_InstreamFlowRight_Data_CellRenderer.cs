// StateMod_InstreamFlowRight_Data_CellRenderer - Class for rending data for instream flow right data tables
...
// ----------------------------------------------------------------------------
// StateMod_InstreamFlowRight_Data_CellRenderer - Class for rending data for 
//	instream flow right data tables
// ----------------------------------------------------------------------------
// Copyright:   See the COPYRIGHT file
// ----------------------------------------------------------------------------
// History:
//
// 2005-03-31	JTS, RTi		Initial version.
// ----------------------------------------------------------------------------
...
namespace DWR.StateMod
{
	...
	/// </summary>
	public class StateMod_InstreamFlowRight_Data_CellRenderer : JWorksheet_AbstractExcelCellRenderer
	{

	/// <summary>
	/// Table model for which this class renders cells.
	/// </summary>
	private StateMod_InstreamFlowRight_Data_TableModel __tableModel;

	/// <summary>
	/// Constructor. </summary>
	/// <param name="tableModel"> the table model for which this class renders cells. </param>
	public StateMod_InstreamFlowRight_Data_CellRenderer(StateMod_InstreamFlowRight_Data_TableModel tableModel)
	{
