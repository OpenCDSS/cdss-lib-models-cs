// StateMod_Diversion_Data_CellRenderer - Class for rendering data for diversion station tables
...
// ----------------------------------------------------------------------------
// StateMod_Diversion_Data_CellRenderer - Class for rendering data for 
...
namespace DWR.StateMod
{
	...
	/// </summary>
	public class StateMod_Diversion_Data_CellRenderer : JWorksheet_AbstractExcelCellRenderer
	{

	/// <summary>
	/// The table model for which this class renders the cells.
	/// </summary>
	private StateMod_Diversion_Data_TableModel __tableModel;
