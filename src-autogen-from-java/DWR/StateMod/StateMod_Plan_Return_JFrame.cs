...
namespace DWR.StateMod
{
	...
	/// </summary>
	public class StateMod_Plan_Return_JFrame : JFrame, ActionListener, KeyListener, MouseListener, WindowListener
	{
	...
	/// </summary>
	private IList<StateMod_ReturnFlow> __currentPlanReturnList = new List<object>();
