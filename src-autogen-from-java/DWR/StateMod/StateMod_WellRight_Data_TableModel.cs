...
namespace DWR.StateMod
{
	...
	/// </summary>
	public class StateMod_WellRight_Data_TableModel : JWorksheet_AbstractRowTableModel, StateMod_Data_TableModel
	{
	...
	/// </summary>
	public const int COL_RIGHT_ID = 0, COL_RIGHT_NAME = 1, COL_STRUCT_ID = 2, COL_ADMIN_NUM = 3, COL_DCR_AMT = 4, COL_ON_OFF = 5, COL_PARCEL_YEAR = 6, COL_PARCEL_CLASS = 7, COL_PARCEL_ID = 8, COL_COLLECTION_TYPE = 9, COL_COLLECTION_PART_TYPE = 10, COL_COLLECTION_PART_ID = 11, COL_COLLECTION_PART_ID_TYPE = 12, COL_X_RIGHT_WDID = 13, COL_X_RIGHT_APPROPRIATION_DATE = 14, COL_X_RIGHT_ADMIN_NUMBER = 15, COL_X_RIGHT_USE = 16, COL_X_PERMIT_RECEIPT = 17, COL_X_PERMIT_DATE = 18, COL_X_PERMIT_ADMIN_NUMBER = 19, COL_X_WELL_YIELD_GPM = 20, COL_X_WELL_YIELD_CFS = 21, COL_X_APEX_GPM = 22, COL_X_APEX_CFS = 23, COL_X_WELL_FRACTION = 24, COL_X_DITCH_FRACTION = 25, COL_X_YIELD_PRORATED_GPM = 26;
	...
	public StateMod_WellRight_Data_TableModel(System.Collections.IList data, bool editable)
	{
		if (data == null)
		{
	...
	public virtual string[] getColumnToolTips()
	{
		...
		tips[COL_RIGHT_ID] = "The well right ID is typically the well station ID followed by .01, .02, etc.";
	...
	/// <summary>
	/// Returns the validators for the given column. </summary>
	/// <param name="col"> The column to return the validators for. </param>
	...
	/// well station widnow and maintaining agreement between the two windows. </summary>
