// StateMod_ReservoirAreaCap_CellRenderer - Class for rendering cells for reservoir area/capacity/seepage tables
...
// ----------------------------------------------------------------------------
// StateMod_ReservoirAreaCap_CellRenderer - Class for rendering cells for 
...
namespace DWR.StateMod
{
	...
	/// </summary>
	public class StateMod_ReservoirAreaCap_CellRenderer : JWorksheet_AbstractExcelCellRenderer
	{

	/// <summary>
	/// Table model for which this class renders the cells.
	/// </summary>
	private StateMod_ReservoirAreaCap_TableModel __tableModel;
