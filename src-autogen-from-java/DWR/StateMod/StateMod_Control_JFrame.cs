...
//ORIGINAL LINE: @SuppressWarnings("serial") public class StateMod_Control_JFrame extends javax.swing.JFrame implements java.awt.event.ActionListener, java.awt.event.ItemListener, java.awt.event.WindowListener
	public class StateMod_Control_JFrame : JFrame, ActionListener, ItemListener, WindowListener
	{

	/// <summary>
	/// Button labels.
	/// </summary>
	private readonly string __BUTTON_APPLY = "Apply", __BUTTON_CANCEL = "Cancel", __BUTTON_CLOSE = "Close", __BUTTON_HELP = "Help";
	...
	/// GUI buttons.
	/// </summary>
	private JButton __applyJButton = null, __cancelJButton = null, __closeJButton = null, __helpJButton = null;

	/// <summary>
	/// GUI text fields.
	/// </summary>
	private JTextField __factor = null, __rfacto = null, __dfacto = null, __ffacto = null, __cfacto = null, __efacto = null, __pfacto = null, __ccall = null, __dataDate1 = null, __dataDate2 = null, __gwmaxrcJTextField = null, __interv = null, __ireopx = null, __soildJTextField = null, __title1 = null, __title2 = null;
	...
	/// </summary>
	private SimpleJComboBox __runDate1SimpleJComboBox = null, __runDate2SimpleJComboBox = null, __cyr1SimpleJComboBox = null, __icallSimpleJComboBox = null, __ichkSimpleJComboBox = null, __icondemSimpleJComboBox = null, __idaySimpleJComboBox = null, __ieffmaxSimpleJComboBox = null, __intervSimpleJComboBox = null, __iopfloSimpleJComboBox = null, __ireachSimpleJComboBox = null, __ireopxSimpleJComboBox = null, __iresopSimpleJComboBox = null, __isjripSimpleJComboBox = null, __isprinkSimpleJComboBox = null, __itsfileSimpleJComboBox = null, __iwellSimpleJComboBox = null, __monevaSimpleJComboBox = null, __soildSimpleJComboBox = null, __isigSimpleJComboBox = null;
	...
	public StateMod_Control_JFrame(StateMod_DataSet dataset, StateMod_DataSet_WindowManager dataset_wm, bool editable)
	{
	...
	public virtual void actionPerformed(ActionEvent @event)
	{
		...
		else if (action.Equals(__BUTTON_CANCEL))
		{
			...
			{
				__dataset_wm.closeWindow(StateMod_DataSet_WindowManager.WINDOW_CONTROL);
			}
			else
			{
				JGUIUtil.close(this);
		...
		else if (action.Equals(__BUTTON_CLOSE))
		{
			...
			{
				Message.printWarning(2, routine, ex);
				Message.printWarning(1, "", "Correct the error or Cancel.", this);
			}
		}
...
//		base.finalize();
	...
	public virtual void itemStateChanged(ItemEvent @event)
	{
		...
		if ((source == __intervSimpleJComboBox) && (@event.getStateChange() == ItemEvent.SELECTED))
		{
			...
			{
				__interv.setEditable(true);
				StateMod_GUIUtil.checkAndSet(__dataset.getInterv(), __interv);
			}
		}
		else if (source == __ireopxSimpleJComboBox && @event.getStateChange() == ItemEvent.SELECTED)
		{
			...
			else
			{
				...
				StateMod_GUIUtil.checkAndSet(__dataset.getIreopx(), __ireopx);
			}
		}
		...
		else if (source == __soildSimpleJComboBox)
		{
			if (__soildSimpleJComboBox.getSelectedIndex() == 2)
			{
				...
				{
					__soildJTextField.setText(StringUtil.formatString(__dataset.getSoild(),"%.1f"));
				}
				else
				{
	...
	/// are not correct(e.g., character string in integer field). </summary>
	/// <exception cref="Exception"> if the visible data are not correct. </exception>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: protected void saveControls() throws Exception
	protected internal virtual void saveControls()
	{
		if (!checkInput())
		{
			return;
		...
		{
			int sindex = s.IndexOf(" - ", StringComparison.Ordinal);
		...
		else
		{
			...
			int icondemSelectIndex = __icondemSimpleJComboBox.getSelectedIndex();
			if (icondemSelectIndex <= 4)
			{
				__dataset.setIcondem(__icondemSimpleJComboBox.getSelectedIndex() + 1);
			}
			else
			{
				if (!StringUtil.isInteger((string) __icondemSimpleJComboBox.getSelectedItem()))
				{
					if (string.ReferenceEquals(message, null))
					{
						message = "\n";
				...
				__dataset.setIcondem(StringUtil.atoi((string) __icondemSimpleJComboBox.getSelectedItem()));
			}
		}
		...
		{
			__dataset.setIchk(StringUtil.atoi(token0));
		}
		...
		else
		{
			...
			int ireopx = -1 * Math.Abs(StringUtil.atoi((string) __ireopx.getText()));
			__dataset.setIreopx(ireopx);
			}
			else if (__ireopxSimpleJComboBox.getSelectedIndex() < 2)
			{
				__dataset.setIreopx(__ireopxSimpleJComboBox.getSelectedIndex());
			}
			else
			{
				if (!StringUtil.isInteger((string) __ireopxSimpleJComboBox.getSelectedItem()))
				{
					if (string.ReferenceEquals(message, null))
					{
						message = "\n";
				...
				__dataset.setIreopx(StringUtil.atoi((string) __ireopxSimpleJComboBox.getSelectedItem()));
			}
		}
		...
		{
			int ireachSelectIndex = __ireachSimpleJComboBox.getSelectedIndex();
			...
			{
				if (!StringUtil.isInteger((string) __ireachSimpleJComboBox.getSelectedItem()))
				{
					if (string.ReferenceEquals(message, null))
					{
						message = "\n";
				...
				__dataset.setIreach(StringUtil.atoi((string) __ireachSimpleJComboBox.getSelectedItem()));
			}
		}
		...
		else
		{
			...
			{
				if (!StringUtil.isInteger((string) __icallSimpleJComboBox.getSelectedItem()))
				{
					if (string.ReferenceEquals(message, null))
					{
						message = "\n";
				...
				__dataset.setIcall(StringUtil.atoi((string) __icallSimpleJComboBox.getSelectedItem()));
			}
		}
		...
		else
		{
			...
			{
				if (!StringUtil.isInteger((string) __idaySimpleJComboBox.getSelectedItem()))
				{
					if (string.ReferenceEquals(message, null))
					{
						message = "\n";
				...
				__dataset.setIday(StringUtil.atoi((string) __idaySimpleJComboBox.getSelectedItem()));
			}
		}
		...
		else
		{
			...
			{
				if (!StringUtil.isInteger((string) __iwellSimpleJComboBox.getSelectedItem()))
				{
					if (string.ReferenceEquals(message, null))
					{
						message = "\n";
				...
				__dataset.setIwell(StringUtil.atoi((string) __iwellSimpleJComboBox.getSelectedItem()));
			}
		}
		...
		{
			int isjripSelectIndex = __isjripSimpleJComboBox.getSelectedIndex();
			...
			{
				if (!StringUtil.isInteger((string) __isjripSimpleJComboBox.getSelectedItem()))
				{
					if (string.ReferenceEquals(message, null))
					{
						message = "\n";
				...
				__dataset.setIsjrip(StringUtil.atoi((string) __isjripSimpleJComboBox.getSelectedItem()));
			}
		}
		...
		{
			int itsfileSelectIndex = __itsfileSimpleJComboBox.getSelectedIndex();
			...
			{
				if (!StringUtil.isInteger((string) __itsfileSimpleJComboBox.getSelectedItem()))
				{
					if (string.ReferenceEquals(message, null))
					{
						message = "\n";
				...
				__dataset.setItsfile(StringUtil.atoi((string) __itsfileSimpleJComboBox.getSelectedItem()));
			}
		}
		...
		{
			int ieffmaxSelectIndex = __ieffmaxSimpleJComboBox.getSelectedIndex();
			...
			{
				if (!StringUtil.isInteger((string) __ieffmaxSimpleJComboBox.getSelectedItem()))
				{
					if (string.ReferenceEquals(message, null))
					{
						message = "\n";
				...
				__dataset.setIeffmax(StringUtil.atoi((string) __ieffmaxSimpleJComboBox.getSelectedItem()));
			}
		}
		...
		{
			int isprinkSelectIndex = __isprinkSimpleJComboBox.getSelectedIndex();
			...
			{
				if (!StringUtil.isInteger((string) __isprinkSimpleJComboBox.getSelectedItem()))
				{
					if (string.ReferenceEquals(message, null))
					{
						message = "\n";
				...
				__dataset.setIsprink(StringUtil.atoi((string) __isprinkSimpleJComboBox.getSelectedItem()));
			}
		}
		...
		else
		{
			...
			{
			__dataset.setSoild("" + (__soildSimpleJComboBox.getSelectedIndex() - 1));
			}
			else
			{
				if (!StringUtil.isDouble((string) __soildSimpleJComboBox.getSelectedItem()))
				{
					if (string.ReferenceEquals(message, null))
					{
						message = "\n";
				...
				__dataset.setSoild((string) __soildSimpleJComboBox.getSelectedItem());
			}
		}
		...
		{
			__dataset.setIsig(__isigSimpleJComboBox.getSelectedIndex());
		}
	...
	private void setupGUI()
	{
		...
		else
		{
			...
			message += "iresop value " + __dataset.getIresop() + " not recognized by GUI.  Allowing as is.\n";
			__iresopSimpleJComboBox.add("" + __dataset.getIresop() + " - Unknown");
		...
		{
			Message.printWarning(1, routine, "cyr1 value not recognized by GUI.");
		}
		...
		catch (Exception)
		{
			...
			message += "moneva value " + __dataset.getMoneva() + " not recognized by GUI.  Allowing as is.\n";
			__monevaSimpleJComboBox.add("" + __dataset.getMoneva() + " - Unknown");
		...
		catch (Exception)
		{
			...
			message += "iopflo value " + __dataset.getIopflo() + " not recognized by GUI.  Allowing as is.\n";
			__iopfloSimpleJComboBox.add("" + __dataset.getIopflo() + " - Unknown");
		...
		{
			intervSelectIndex = 0;
			__interv.setText((new int?(__dataset.getInterv())).ToString());
		}
		...
		__ichkSimpleJComboBox.add("21 - Print top of binary file for *.xbn report");
		__ichkSimpleJComboBox.add("24 - Print detailed results for operating rule 23" + " (downstream call)");
		__ichkSimpleJComboBox.add("30 - Do not print daily binary results");
		__ichkSimpleJComboBox.add("90 - Print detailed water use data from return");
		...
		__ichkSimpleJComboBox.add("201 - Print detailed output for ISF call water right of " + "interest");
		__ichkSimpleJComboBox.add("202 - Print detailed output for reservoir call water right of " + "interest");
		__ichkSimpleJComboBox.add("203 - Print detailed output for diversion call water right of " + "interest");

		if ((ichkSelectIndex != 0) && (ichkSelectIndex != 1) && (ichkSelectIndex != 4) && (ichkSelectIndex != 5) && (ichkSelectIndex != 6) && (ichkSelectIndex != 7) && (ichkSelectIndex != 8) && (ichkSelectIndex != 9) && (ichkSelectIndex != 10) && (ichkSelectIndex != 21) && (ichkSelectIndex != 24) && (ichkSelectIndex != 30) && (ichkSelectIndex != 90) && (ichkSelectIndex != 91) && (ichkSelectIndex != 92) && (ichkSelectIndex != 201) && (ichkSelectIndex != 202) && (ichkSelectIndex != 203))
		{
			if (string.ReferenceEquals(message, null))
			{
				message = "\n";
			}
			 message += "Detailed output \"ichk\" value " + ichkSelectIndex + " not recognized by GUI.  Allowing as is.\n";
		...
		if (__dataset.getIreopx() < 0)
		{
			...
			ireopxSelectIndex = 2;
			__ireopx.setEditable(true);
			StateMod_GUIUtil.checkAndSet(Math.Abs(__dataset.getIreopx()), __ireopx);
		}
		else
		{
		...
		__ireopxSimpleJComboBox.add("0 - Reoperate for reservoir releases and " + "returns");
		__ireopxSimpleJComboBox.add("1 - Do not reoperate");
		__ireopxSimpleJComboBox.add("Reoperate when the sum (acft) of " + "reservoir releases exceeds:");
		try
		{
		...
		catch (Exception)
		{
			...
			message += "ireopx value " + __dataset.getIreopx() + " not recognized by GUI.  Allowing as is.";
			__ireopxSimpleJComboBox.add("" + __dataset.getIreopx() + " - Unknown");
		...
		if (__dataset.getSoild() > 0)
		{
			soildSelectIndex = 2;
			__soildJTextField.setEditable(true);
			StateMod_GUIUtil.checkAndSet(__dataset.getSoild(), __soildJTextField);
		}
		...
		__soildSimpleJComboBox.add("-1 - Soil moisture file provided but not " + "used");
		__soildSimpleJComboBox.add("0 - No soil moisture file provided");
		__soildSimpleJComboBox.add("Soil moisture file used where soil " + "zone depth, FT, is:");
		...
		catch (Exception)
		{
			...
			message += "Significant figures \"isig\" value " + __dataset.getIsig() + " not recognized by GUI.  Allowing as is.";
			__isigSimpleJComboBox.add("" + __dataset.getIsig() + " - Unknown");
		...
		catch (Exception)
		{
			...
			message += "icondem value " + __dataset.getIcondem() + " not recognized by GUI.  Allowing as is.\n";
			__icondemSimpleJComboBox.add("" + __dataset.getIcondem() + " - Unknown");
		...
		__ireachSimpleJComboBox.add("2 - No instream reach approach and " + "monthly instream demands file");
		__ireachSimpleJComboBox.add("3 - Instream reach approach and monthly " + "instream demands file");
		...
		catch (Exception)
		{
			...
			message += "ireach value " + __dataset.getIreach() + " not recognized by GUI.  Allowing as is.\n";
			__ireachSimpleJComboBox.add("" + __dataset.getIreach() + " - Unknown");
		...
		catch (Exception)
		{
			...
			message += "icall value " + __dataset.getIcall() + " not recognized by GUI.  Allowing as is.\n";
			__icallSimpleJComboBox.add("" + __dataset.getIcall() + " - Unknown");
		...
		__idaySimpleJComboBox.add("-1 - No daily analysis but daily data files " + "are in response file");
		...
		catch (Exception)
		{
			...
			message += "iday value " + __dataset.getIday() + " not recognized by GUI.  Allowing as is.\n";
			__idaySimpleJComboBox.add("" + __dataset.getIday() + " - Unknown");
		...
		__iwellSimpleJComboBox.add("-1 - No well analysis but well data files " + "are in response file");
		__iwellSimpleJComboBox.add("0 - No well analysis");
		__iwellSimpleJComboBox.add("1 - Well analysis with no maximum " + "recharge");
		__iwellSimpleJComboBox.add("2 - Well analysis with constant " + "maximum recharge");
		__iwellSimpleJComboBox.add("3 - Well analysis with variable " + "maximum recharge");
		...
		catch (Exception)
		{
			...
			message += "iwell value " + __dataset.getIwell() + " not recognized by GUI.  Allowing as is.\n";
			__iwellSimpleJComboBox.add("" + __dataset.getIwell() + " - Unknown");
		...
		__isjripSimpleJComboBox.add("-1 - No SJRIP analysis but file in " + "response file");
		...
		catch (Exception)
		{
			...
			message += "isjrip value " + __dataset.getIsjrip() + " not recognized by GUI.  Allowing as is.\n";
			__isjripSimpleJComboBox.add("" + __dataset.getIsjrip() + " - Unknown");
		...
		else
		{
			...
			message += "itsfile value " + __dataset.getItsfile() + " not recognized by GUI.  Allowing as is.\n";
			__itsfileSimpleJComboBox.add("" + __dataset.getItsfile() + " - Unknown");
		...
		__ieffmaxSimpleJComboBox.add("-1 - IWR file in response file but not " + "used");
		__ieffmaxSimpleJComboBox.add("0 - No IWR file");
		__ieffmaxSimpleJComboBox.add("1 - IWR file provided and variable " + "efficiency used");
		...
		catch (Exception)
		{
			...
			message += "ieffmax value " + __dataset.getIeffmax() + " not recognized by GUI.  Allowing as is.\n";
			__ieffmaxSimpleJComboBox.add("" + __dataset.getIeffmax() + " - Unknown");
		...
		__isprinkSimpleJComboBox.add("1 - Use sprinkler data from irrigation " + "practice file");
		...
		catch (Exception)
		{
			...
			message += "isprink value " + __dataset.getIsprink() + " not recognized by GUI.  Allowing as is.\n";
			__isprinkSimpleJComboBox.add("" + __dataset.getIsprink() + " - Unknown");
			__isprinkSimpleJComboBox.select(2);
		}

		////////////////////////////////////////////////////////
		// earliest POR
		DateTime earliestPOR_DateTime = StateMod_Util.findEarliestDateInPOR(__dataset);
		...
		{
			StateMod_GUIUtil.checkAndSet(earliestPOR_DateTime.getYear(), __dataDate1);
		}

		////////////////////////////////////////////////////////
		// latestPOR
		DateTime latestPOR_DateTime = StateMod_Util.findLatestDateInPOR(__dataset);
		...
		{
			StateMod_GUIUtil.checkAndSet(latestPOR_DateTime.getYear(), __dataDate2);
		}
		...
		StateMod_GUIUtil.checkAndSet(__dataset.getGwmaxrc(), __gwmaxrcJTextField);
		...
		if (__dataDate1.getText().Equals("NA") || __dataDate2.getText().Equals("NA"))
		{
		...
		{
			for (int i = earliestPOR_DateTime.getYear(); i <= latestPOR_DateTime.getYear(); i++)
			{
		...
		////////////////////////////////////////////////////////
		// general panel
		JGUIUtil.addComponent(generalPanel, new JLabel("Title (1): "), 0, 0, 1, 1, 0, 0, 5, 5, 0, 0, GridBagConstraints.NONE, GridBagConstraints.EAST);
		JGUIUtil.addComponent(generalPanel, __title1, 1, 0, 9, 1, 0, 0, 5, 0, 0, 5, GridBagConstraints.NONE, GridBagConstraints.WEST);

		JGUIUtil.addComponent(generalPanel, new JLabel("Title (2): "), 0, 1, 1, 1, 0, 0, 5, 5, 0, 0, GridBagConstraints.NONE, GridBagConstraints.EAST);
		JGUIUtil.addComponent(generalPanel, __title2, 1, 1, 9, 1, 0, 0, 5, 0, 0, 5, GridBagConstraints.NONE, GridBagConstraints.WEST);

		JGUIUtil.addComponent(generalPanel,new JLabel("Data start:"), 0, 2, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.EAST);
		JGUIUtil.addComponent(generalPanel, __dataDate1, 1, 2, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.WEST);
		JGUIUtil.addComponent(generalPanel, new JLabel("Data end:"), 2, 2, 1, 1, 0, 0, 0, 10, 0, 0, GridBagConstraints.NONE, GridBagConstraints.WEST);
		JGUIUtil.addComponent(generalPanel, __dataDate2, 3, 2, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.WEST);
		JGUIUtil.addComponent(generalPanel, new JLabel("Run start:"), 0, 3, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.EAST);
		JGUIUtil.addComponent(generalPanel, __runDate1SimpleJComboBox, 1, 3, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.WEST);
		JGUIUtil.addComponent(generalPanel, new JLabel("Run end:"), 2, 3, 1, 1, 0, 0, 0, 10, 0, 0, GridBagConstraints.NONE, GridBagConstraints.WEST);
		JGUIUtil.addComponent(generalPanel, __runDate2SimpleJComboBox, 3, 3, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.WEST);

		JGUIUtil.addComponent(generalPanel, new JLabel("Output units:"), 0, 4, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.EAST);
		JGUIUtil.addComponent(generalPanel, __iresopSimpleJComboBox, 1, 4, 3, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.WEST);

		JGUIUtil.addComponent(generalPanel, new JLabel("Year type:"), 0, 5, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.EAST);
		JGUIUtil.addComponent(generalPanel, __cyr1SimpleJComboBox, 1, 5, 8, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.WEST);

		JGUIUtil.addComponent(generalPanel, new JLabel("Data start and end are determined from " + "historical input time series."), 0, 6, 20, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.WEST);

		////////////////////////////////////////////////////////
		// options panel
		JGUIUtil.addComponent(optionsPanel, new JLabel("Evaporation/precipitation data:"), 0, 0, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.EAST);
		JGUIUtil.addComponent(optionsPanel, __monevaSimpleJComboBox, 1, 0, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.WEST);

		JGUIUtil.addComponent(optionsPanel, new JLabel("Streamflow data:"), 0, 1, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.EAST);
		JGUIUtil.addComponent(optionsPanel, __iopfloSimpleJComboBox, 1, 1, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.WEST);

		JGUIUtil.addComponent(optionsPanel, new JLabel("Number of delay table entries:"), 0, 2, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.EAST);

		JGUIUtil.addComponent(optionsPanel, __intervSimpleJComboBox, 1, 2, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.WEST);

		JGUIUtil.addComponent(optionsPanel, __interv, 2, 2, 1, 1, 0, 0, 0, 10, 0, 0, GridBagConstraints.NONE, GridBagConstraints.WEST);

		JGUIUtil.addComponent(optionsPanel, new JLabel("Demand data type:"), 0, 3, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.EAST);
		JGUIUtil.addComponent(optionsPanel, __icondemSimpleJComboBox, 1, 3, 2, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.WEST);

		JGUIUtil.addComponent(optionsPanel, new JLabel("Instream flow approach:"), 0, 4, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.EAST);
		JGUIUtil.addComponent(optionsPanel, __ireachSimpleJComboBox, 1, 4, 8, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.WEST);
		...
		JGUIUtil.addComponent(factorsPanel, new JLabel("Factor to convert from CFS to AF/D:"), 0, 0, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.EAST);
		JGUIUtil.addComponent(factorsPanel, __factor, 1, 0, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.WEST);

		JGUIUtil.addComponent(factorsPanel, new JLabel("Divisor for streamflow data units:"), 0, 1, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.EAST);
		JGUIUtil.addComponent(factorsPanel, __rfacto, 1, 1, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.WEST);

		JGUIUtil.addComponent(factorsPanel, new JLabel("Divisor for diversion data units:"), 0, 2, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.EAST);
		JGUIUtil.addComponent(factorsPanel, __dfacto, 1, 2, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.WEST);

		JGUIUtil.addComponent(factorsPanel, new JLabel("Divisor for instream flow data units:"), 0, 3, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.EAST);
		JGUIUtil.addComponent(factorsPanel, __ffacto, 1, 3, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.WEST);

		JGUIUtil.addComponent(factorsPanel, new JLabel("Factor to convert reservoir content data to AF:"), 0, 4, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.EAST);
		JGUIUtil.addComponent(factorsPanel, __cfacto, 1, 4, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.WEST);

		JGUIUtil.addComponent(factorsPanel, new JLabel("Factor to convert evaporation data to feet:"), 0, 5, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.EAST);
		JGUIUtil.addComponent(factorsPanel, __efacto, 1, 5, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.WEST);

		JGUIUtil.addComponent(factorsPanel, new JLabel("Factor to convert precipitation data to feet:"), 0, 6, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.EAST);
		JGUIUtil.addComponent(factorsPanel, __pfacto, 1, 6, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.WEST);


		////////////////////////////////////////////////////////
		// checks panel

		JGUIUtil.addComponent(checksPanel, new JLabel("Detailed output:"), 0, 0, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.EAST);
		JGUIUtil.addComponent(checksPanel, __ichkSimpleJComboBox, 1, 0, 2, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.WEST);

		JGUIUtil.addComponent(checksPanel, new JLabel("Detailed call output:"), 0, 1, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.EAST);

		JGUIUtil.addComponent(checksPanel, __icallSimpleJComboBox, 1, 1, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.WEST);

		JGUIUtil.addComponent(checksPanel, new JLabel("Call water right of interest:"), 0, 2, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.EAST);

		JGUIUtil.addComponent(checksPanel, __ccall, 1, 2, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.WEST);


		////////////////////////////////////////////////////////
		// advanced panel

		JGUIUtil.addComponent(advancedPanel, new JLabel("Daily analysis:"), 0, 0, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.EAST);
		JGUIUtil.addComponent(advancedPanel, __idaySimpleJComboBox, 1, 0, 8, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.WEST);

		JGUIUtil.addComponent(advancedPanel, new JLabel("Well analysis:"), 0, 1, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.EAST);
		JGUIUtil.addComponent(advancedPanel, __iwellSimpleJComboBox, 1, 1, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.WEST);

		JGUIUtil.addComponent(advancedPanel, new JLabel("Max recharge (CFS):"), 0, 2, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.EAST);
		JGUIUtil.addComponent(advancedPanel, __gwmaxrcJTextField, 1, 2, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.WEST);

		JGUIUtil.addComponent(advancedPanel, new JLabel("San juan:"), 0, 3, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.EAST);
		JGUIUtil.addComponent(advancedPanel, __isjripSimpleJComboBox, 1, 3, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.WEST);

		JGUIUtil.addComponent(advancedPanel, new JLabel("Variable efficiency:"), 0, 4, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.EAST);
		JGUIUtil.addComponent(advancedPanel, __itsfileSimpleJComboBox, 1, 4, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.WEST);

		JGUIUtil.addComponent(advancedPanel, new JLabel("Sprinkler irrigation:"), 0, 5, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.EAST);
		JGUIUtil.addComponent(advancedPanel, __isprinkSimpleJComboBox, 1, 5, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.WEST);

		JGUIUtil.addComponent(advancedPanel, new JLabel("Irrigation water requirement:"), 0, 6, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.EAST);
		JGUIUtil.addComponent(advancedPanel, __ieffmaxSimpleJComboBox, 1, 6, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.WEST);

		JGUIUtil.addComponent(advancedPanel, new JLabel("Soil moisture:"), 0, 7, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.EAST);
		JGUIUtil.addComponent(advancedPanel, __soildSimpleJComboBox, 1, 7, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.WEST);
		JGUIUtil.addComponent(advancedPanel, __soildJTextField, 2, 7, 1, 1, 0, 0, 0, 10, 0, 0, GridBagConstraints.NONE, GridBagConstraints.WEST);

		JGUIUtil.addComponent(advancedPanel, new JLabel("Reoperate reservoirs:"), 0, 8, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.EAST);
		JGUIUtil.addComponent(advancedPanel, __ireopxSimpleJComboBox, 1, 8, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.WEST);
		JGUIUtil.addComponent(advancedPanel, __ireopx, 2, 8, 1, 1, 0, 0, 0, 10, 0, 0, GridBagConstraints.NONE, GridBagConstraints.WEST);

		JGUIUtil.addComponent(advancedPanel, new JLabel("Significant figures:"), 0, 9, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.EAST);
		JGUIUtil.addComponent(advancedPanel, __isigSimpleJComboBox, 1, 9, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.WEST);
	...
	//	buttonPanel.add(__helpJButton);
		...
		__applyJButton.setToolTipText("<HTML>Apply changes.<br>File...Save is " + "still required to update files.</HTML>");
		__cancelJButton.addActionListener(this);
		__cancelJButton.setToolTipText("Cancel changes, reverting to previous " + "values.");
		__closeJButton.addActionListener(this);
		__closeJButton.setToolTipText("<HTML>Apply changes and close window." + "<br>File...Save is still required to save files.</HTML>");
