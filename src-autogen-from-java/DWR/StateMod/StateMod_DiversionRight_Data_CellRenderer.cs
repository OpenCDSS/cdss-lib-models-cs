// StateMod_DiversionRight_Data_CellRenderer - Class for rendering data for diversion right tables
...
// ----------------------------------------------------------------------------
// StateMod_DiversionRight_Data_CellRenderer - Class for rendering data for 
...
namespace DWR.StateMod
{
	...
	/// </summary>
	public class StateMod_DiversionRight_Data_CellRenderer : JWorksheet_AbstractExcelCellRenderer
	{

	/// <summary>
	/// The table model for which this class renders the cells.
	/// </summary>
	private StateMod_DiversionRight_Data_TableModel __tableModel;

	/// <summary>
	/// Constructor. </summary>
	/// <param name="tableModel"> the table model for which this class renders the cells. </param>
	public StateMod_DiversionRight_Data_CellRenderer(StateMod_DiversionRight_Data_TableModel tableModel)
	{
