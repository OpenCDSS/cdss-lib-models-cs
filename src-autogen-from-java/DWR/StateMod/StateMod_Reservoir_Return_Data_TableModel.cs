...
// StateMod_Reservoir_Return_Data_TableModel - This class displays reservoir station return assignment data.
...
namespace DWR.StateMod
{
	...
	/// </summary>
	public class StateMod_Reservoir_Return_Data_TableModel : JWorksheet_AbstractRowTableModel, StateMod_Data_TableModel
	{
	...
	/// </summary>
	public const int COL_RESERVOIR_ID = 0, COL_RIVER_NODE_ID = 1, COL_PERCENT_RETURN = 2, COL_DELAY_TABLE_ID = 3, COL_COMMENT = 4;
...
//ORIGINAL LINE: public StateMod_Reservoir_Return_Data_TableModel(java.util.List data, boolean editable) throws Exception
	public StateMod_Reservoir_Return_Data_TableModel(System.Collections.IList data, bool editable)
	{
		if (data == null)
		{
