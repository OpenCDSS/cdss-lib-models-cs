...
namespace DWR.StateMod
{
	...
	/// </summary>
	public class StateMod_StreamGage_TableModel : JWorksheet_AbstractRowTableModel
	{
...
//ORIGINAL LINE: public StateMod_StreamGage_TableModel(java.util.List data) throws Exception
	public StateMod_StreamGage_TableModel(System.Collections.IList data) : this(data, true)
	{
	}
	...
	/// <exception cref="Exception"> if an invalid data or dmi was passed in. </exception>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public StateMod_StreamGage_TableModel(java.util.List data, boolean editable) throws Exception
	public StateMod_StreamGage_TableModel(System.Collections.IList data, bool editable)
	{
		if (data == null)
		{
			throw new Exception("Invalid data Vector passed to " + "StateMod_StreamGage_TableModel constructor.");
		}
		_rows = data.Count;
		_data = data;
		__editable = editable;
