...
// StateMod_Plan_Data_JFrame - This class is a JFrame for displaying a list of StateMod_Plan data in a worksheet
...
namespace DWR.StateMod
{
	...
	/// </summary>
	public class StateMod_Plan_Data_JFrame : StateMod_Data_JFrame
	{
...
//ORIGINAL LINE: public StateMod_Plan_Data_JFrame(java.util.List<StateMod_Plan> data, String titleString, boolean editable) throws Exception
	public StateMod_Plan_Data_JFrame(IList<StateMod_Plan> data, string titleString, bool editable) : base(data, titleString, editable)
	{
