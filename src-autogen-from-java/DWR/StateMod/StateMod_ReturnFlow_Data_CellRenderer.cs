...
namespace DWR.StateMod
{
	...
	/// </summary>
	public class StateMod_ReturnFlow_Data_CellRenderer : JWorksheet_AbstractExcelCellRenderer
	{
	...
	public StateMod_ReturnFlow_Data_CellRenderer(StateMod_ReturnFlow_Data_TableModel tableModel)
	{
