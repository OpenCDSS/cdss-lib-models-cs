...
// StateMod_Reservoir_Collection_Data_TableModel - Table model for displaying reservoir collection data.
...
// ----------------------------------------------------------------------------
// StateMod_Reservoir_Collection_Data_TableModel - Table model for displaying 
...
namespace DWR.StateMod
{
	...
	/// </summary>
	public class StateMod_Reservoir_Collection_Data_TableModel : JWorksheet_AbstractRowTableModel
	{
	...
	public StateMod_Reservoir_Collection_Data_TableModel(System.Collections.IList data) : this(data, false)
	{
	}
	...
	public StateMod_Reservoir_Collection_Data_TableModel(System.Collections.IList data, bool editable)
	{
		if (data == null)
		{
