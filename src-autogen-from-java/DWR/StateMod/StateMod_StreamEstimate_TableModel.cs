...
// StateMod_StreamEstimate_TableModel - table model for displaying stream estimate station data
...
namespace DWR.StateMod
{
	...
	/// </summary>
	public class StateMod_StreamEstimate_TableModel : JWorksheet_AbstractRowTableModel
	{
...
//ORIGINAL LINE: public StateMod_StreamEstimate_TableModel(java.util.List data) throws Exception
	public StateMod_StreamEstimate_TableModel(System.Collections.IList data) : this(data, true)
	{
	}
	...
	/// <exception cref="Exception"> if an invalid data or dmi was passed in. </exception>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public StateMod_StreamEstimate_TableModel(java.util.List data, boolean editable) throws Exception
	public StateMod_StreamEstimate_TableModel(System.Collections.IList data, bool editable)
	{
		if (data == null)
		{
