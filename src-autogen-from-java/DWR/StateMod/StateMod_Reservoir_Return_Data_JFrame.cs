...
// StateMod_Reservoir_Return_Data_JFrame - JFrame for displaying a list of reservoir station return data in a worksheet
...
namespace DWR.StateMod
{
	...
	/// <summary>
	/// This class is a JFrame for displaying a list of reservoir station return data in
	/// a worksheet.  The worksheet data can be exported to a file or printed.
	/// </summary>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @SuppressWarnings("serial") public class StateMod_Reservoir_Return_Data_JFrame extends StateMod_Data_JFrame
	public class StateMod_Reservoir_Return_Data_JFrame : StateMod_Data_JFrame
	{
...
//ORIGINAL LINE: public StateMod_Reservoir_Return_Data_JFrame(java.util.List<StateMod_ReturnFlow> data, String titleString, boolean editable) throws Exception
	public StateMod_Reservoir_Return_Data_JFrame(IList<StateMod_ReturnFlow> data, string titleString, bool editable) : base()
	{
...
//ORIGINAL LINE: protected RTi.Util.GUI.JScrollWorksheet buildJScrollWorksheet() throws Exception
	...
	{
		StateMod_Reservoir_Return_Data_TableModel tableModel = new StateMod_Reservoir_Return_Data_TableModel(_data, _editable);
		StateMod_Reservoir_Return_Data_CellRenderer cellRenderer = new StateMod_Reservoir_Return_Data_CellRenderer(tableModel);
