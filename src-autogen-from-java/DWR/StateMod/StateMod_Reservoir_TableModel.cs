...
namespace DWR.StateMod
{
	...
	/// </summary>
	public class StateMod_Reservoir_TableModel : JWorksheet_AbstractRowTableModel
	{
...
//ORIGINAL LINE: public StateMod_Reservoir_TableModel(java.util.List data, boolean editable) throws Exception
	public StateMod_Reservoir_TableModel(System.Collections.IList data, bool editable) : this(data, editable, true)
	{
	}
	...
	/// <exception cref="Exception"> if an invalid data or dmi was passed in. </exception>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public StateMod_Reservoir_TableModel(java.util.List data, boolean editable, boolean compactForm) throws Exception
	public StateMod_Reservoir_TableModel(System.Collections.IList data, bool editable, bool compactForm)
	{
		if (data == null)
		{
			throw new Exception("Invalid data Vector passed to " + "StateMod_Reservoir_TableModel constructor.");
		}
		_rows = data.Count;
		_data = data;
