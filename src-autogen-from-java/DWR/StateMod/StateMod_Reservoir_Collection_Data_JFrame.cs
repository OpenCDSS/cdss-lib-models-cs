...
// StateMod_Reservoir_Collection_Data_JFrame - JFrame that displays reservoir collection data in a tabular format.
...
//ORIGINAL LINE: @SuppressWarnings("serial") public class StateMod_Reservoir_Collection_Data_JFrame extends StateMod_Data_JFrame
	public class StateMod_Reservoir_Collection_Data_JFrame : StateMod_Data_JFrame
	{
...
//ORIGINAL LINE: public StateMod_Reservoir_Collection_Data_JFrame(java.util.List<StateMod_Reservoir> data, String titleString, boolean editable) throws Exception
	public StateMod_Reservoir_Collection_Data_JFrame(IList<StateMod_Reservoir> data, string titleString, bool editable) : base(data, titleString, editable)
	{
...
//ORIGINAL LINE: protected RTi.Util.GUI.JScrollWorksheet buildJScrollWorksheet() throws Exception
	...
	{
		StateMod_Reservoir_Collection_Data_TableModel tableModel = new StateMod_Reservoir_Collection_Data_TableModel(_data, _editable);
		StateMod_Reservoir_Collection_Data_CellRenderer cellRenderer = new StateMod_Reservoir_Collection_Data_CellRenderer(tableModel);
