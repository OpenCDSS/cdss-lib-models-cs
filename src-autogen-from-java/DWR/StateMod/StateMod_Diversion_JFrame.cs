...
//ORIGINAL LINE: @SuppressWarnings("serial") public class StateMod_Diversion_JFrame extends javax.swing.JFrame implements java.awt.event.ActionListener, java.awt.event.ItemListener, java.awt.event.KeyListener, java.awt.event.MouseListener, java.awt.event.WindowListener, RTi.Util.GUI.JWorksheet_SortListener
	public class StateMod_Diversion_JFrame : JFrame, ActionListener, ItemListener, KeyListener, MouseListener, WindowListener, JWorksheet_SortListener
	{
	...
	/// </summary>
	private const string __BUTTON_SHOW_ON_MAP = "Show on Map", __BUTTON_SHOW_ON_NETWORK = "Show on Network", __BUTTON_APPLY = "Apply", __BUTTON_CANCEL = "Cancel", __BUTTON_CLOSE = "Close";
	...
	/// GUI JButtons.
	/// </summary>
	private JButton __findNextDiv_JButton = null, __waterRights_JButton = null, __returnFlow_JButton = null, __graph_JButton = null, __table_JButton = null, __summary_JButton = null, __help_JButton = null, __close_JButton = null, __cancel_JButton = null, __apply_JButton = null, __showOnMap_JButton = null, __showOnNetwork_JButton = null;

	/// <summary>
	/// Checkboxes for selecting the kind of time series to display.
	/// </summary>
	private JCheckBox __ts_diversion_monthly_JCheckBox, __ts_diversion_daily_JCheckBox, __ts_diversion_est_daily_JCheckBox, __ts_water_right_monthly_JCheckBox, __ts_water_right_daily_JCheckBox, __ts_demand_monthly_JCheckBox, __ts_demand_override_monthly_JCheckBox, __ts_demand_ave_monthly_JCheckBox, __ts_demand_daily_JCheckBox, __ts_demand_est_daily_JCheckBox, __ts_ipy_yearly_JCheckBox, __ts_cwr_monthly_JCheckBox, __ts_cwr_daily_JCheckBox, __ts_cwr_est_daily_JCheckBox;
	...
	/// GUI JRadioButtons.
	/// </summary>
	private JRadioButton __searchID_JRadioButton = null, __searchName_JRadioButton = null, __effConstant_JRadioButton = null, __effMonthly_JRadioButton = null;

	/// <summary>
	/// GUI JTextFields.
	/// </summary>
	private JTextField __searchID_JTextField = null, __searchName_JTextField = null, __diversionStationID_JTextField = null, __diversionName_JTextField = null, __riverNodeID_JTextField = null, __diversionCapacity_JTextField = null, __awc_JTextField = null, __userName_JTextField = null, __irrigatedAcreage_JTextField = null;
	...
	/// </summary>
	private SimpleJComboBox __diversionSwitch_JComboBox = null, __diversionDailyID_JComboBox = null, __demandType_JComboBox = null, __demandSource_JComboBox = null, __replacementReservoirOption_JComboBox = null, __useType_JComboBox = null;
	...
	/// </summary>
	private IList<StateMod_Diversion> __diversionsVector;

	/// <summary>
	/// Constructor. </summary>
	/// <param name="dataset"> StateMod_DataSet containing diversion data. </param>
	...
	public StateMod_Diversion_JFrame(StateMod_DataSet dataset, StateMod_DataSet_WindowManager dataset_wm, bool editable)
	{
		...
		__diversionsVector = (IList<StateMod_Diversion>)__diversionsComponent.getData();
		int size = __diversionsVector.Count;
		StateMod_Diversion div = null;
		for (int i = 0; i < size; i++)
		{
			div = __diversionsVector[i];
			div.createBackup();
		}
	...
	/// <param name="dataset_wm"> the dataset window manager or null if the data set windows are not being managed. </param>
	/// <param name="diversion"> the diversion to select and show in the list of diversion </param>
	/// <param name="editable"> whether the data values on the form can be edited or not. </param>
	public StateMod_Diversion_JFrame(StateMod_DataSet dataset, StateMod_DataSet_WindowManager dataset_wm, StateMod_Diversion diversion, bool editable)
	{
		StateMod_GUIUtil.setTitle(this, dataset, "Diversions", null);
		JGUIUtil.setIcon(this, JGUIUtil.getIconImage());
		__dataset = dataset;
	...
	public virtual void actionPerformed(ActionEvent e)
	{
		...
		else if (source == __close_JButton)
		{
			...
			bool changed = false;
			foreach (StateMod_Diversion div in __diversionsVector)
			{
		...
		else if (source == __showOnMap_JButton)
		{
			...
			__dataset_wm.showOnMap(getSelectedDiversion(), "Div: " + getSelectedDiversion().getID() + " - " + getSelectedDiversion().getName(), new GRLimits(shape.xmin, shape.ymin, shape.xmax, shape.ymax), geoRecord.getLayer().getProjection());
		}
		else if (source == __showOnNetwork_JButton)
		{
			...
			{
				HydrologyNode node = networkEditor.getNetworkJComponent().findNode(getSelectedDiversion().getID(), false, false);
				if (node != null)
				{
					__dataset_wm.showOnNetwork(getSelectedDiversion(), "Div: " + getSelectedDiversion().getID() + " - " + getSelectedDiversion().getName(), new GRLimits(node.getX(),node.getY(),node.getX(),node.getY()));
				}
			}
		}
		else if (source == __waterRights_JButton)
		{
			...
			{
				new ResponseJDialog(this, "You must first select a diversion from the list.", ResponseJDialog.OK);
				return;
			}

			// set placeholder to current diversion
			StateMod_Diversion div = __diversionsVector[__currentDiversionIndex];
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @SuppressWarnings("unchecked") java.util.List<StateMod_RiverNetworkNode> data = (java.util.List<StateMod_RiverNetworkNode>)comp.getData();
			IList<StateMod_RiverNetworkNode> data = (IList<StateMod_RiverNetworkNode>)comp.getData();
		...
		{
			StateMod_Diversion div = __diversionsVector[__currentDiversionIndex];
			warning = "\nDiversion:  " + StateMod_Util.formatDataLabel(div.getID(), div.getName()) + warning + "\nCorrect or Cancel.";
	...
	{
		if ((__ts_diversion_monthly_JCheckBox.isEnabled() && __ts_diversion_monthly_JCheckBox.isSelected()) || (__ts_diversion_daily_JCheckBox.isEnabled() && __ts_diversion_daily_JCheckBox.isSelected()) || (__ts_diversion_est_daily_JCheckBox.isEnabled() && __ts_diversion_est_daily_JCheckBox.isSelected()) || (__ts_water_right_monthly_JCheckBox.isEnabled() && __ts_water_right_monthly_JCheckBox.isSelected()) || (__ts_water_right_daily_JCheckBox.isEnabled() && __ts_water_right_daily_JCheckBox.isSelected()) || (__ts_demand_monthly_JCheckBox.isEnabled() && __ts_demand_monthly_JCheckBox.isSelected()) || (__ts_demand_override_monthly_JCheckBox.isEnabled() && __ts_demand_override_monthly_JCheckBox.isSelected()) || (__ts_demand_ave_monthly_JCheckBox.isEnabled() && __ts_demand_ave_monthly_JCheckBox.isSelected()) || (__ts_demand_daily_JCheckBox.isEnabled() && __ts_demand_daily_JCheckBox.isSelected()) || (__ts_demand_est_daily_JCheckBox.isEnabled() && __ts_demand_est_daily_JCheckBox.isSelected()) || (__ts_ipy_yearly_JCheckBox.isEnabled() && __ts_ipy_yearly_JCheckBox.isSelected()) || (__ts_cwr_monthly_JCheckBox.isEnabled() && __ts_cwr_monthly_JCheckBox.isSelected()) || (__ts_cwr_daily_JCheckBox.isEnabled() && __ts_cwr_daily_JCheckBox.isSelected()) || (__ts_cwr_est_daily_JCheckBox.isEnabled() && __ts_cwr_est_daily_JCheckBox.isSelected()))
		{
	...
	/// <summary>
	/// Display the efficiency values from the data object to the GUI. </summary>
	/// <param name="monthly_data"> If true, then the monthly efficiencies are enabled and the
	/// constant efficiency is disabled.  If false, the monthly efficiencies are
	/// disabled and the constant efficiency is enabled. </param>
	/// <param name="reset_data"> If true, the display values are reset from the data object -
	/// suitable for when a new diversion is picked.  If false, the old values remain,
	/// suitable for when the use is just changing radio buttons. </param>
	private void displayEff(bool monthly_data, bool reset_data)
	{
		if (__currentDiversionIndex == -1)
		{
			return;
	...
	/// and the time series checkboxes that are selected. </summary>
	/// <param name="type"> the type of view to display. </param>
	public virtual void displayTSViewJFrame(string type)
	{
		...
		if (__ts_ipy_yearly_JCheckBox.isSelected() && __ts_ipy_yearly_JCheckBox.isEnabled())
		{
			...
			props.set("SubProduct " + sub + ".SubTitleString=Irrigated Acres for Diversion " + div.getID() + " (" + div.getName() + ")");
		...
		if (__ts_ipy_yearly_JCheckBox.isSelected() && __ts_ipy_yearly_JCheckBox.isEnabled())
		{
			...
			its = 0;
			props.set("SubProduct " + sub + ".GraphType=Line");
			props.set("SubProduct " + sub + ".SubTitleString=Efficiencies for Diversion " + div.getID() + " (" + div.getName() + ")");
			props.set("SubProduct " + sub + ".SubTitleFontSize=12");
		...
		if ((__ts_diversion_monthly_JCheckBox.isSelected() && __ts_diversion_monthly_JCheckBox.isEnabled()) || (__ts_diversion_monthly_JCheckBox.isSelected() && __ts_diversion_monthly_JCheckBox.isEnabled()) || (__ts_demand_monthly_JCheckBox.isSelected() && __ts_demand_monthly_JCheckBox.isEnabled()) || (__ts_demand_override_monthly_JCheckBox.isSelected() && __ts_demand_override_monthly_JCheckBox.isEnabled()) || (__ts_cwr_monthly_JCheckBox.isSelected() && __ts_cwr_monthly_JCheckBox.isEnabled()) || (__ts_water_right_monthly_JCheckBox.isSelected() && __ts_water_right_monthly_JCheckBox.isEnabled()))
		{
			// Do the monthly graph...
			++sub;
			its = 0;
			props.set("SubProduct " + sub + ".GraphType=Line");
			props.set("SubProduct " + sub + ".SubTitleString=Monthly Data for Diversion " + div.getID() + " (" + div.getName() + ")");
			props.set("SubProduct " + sub + ".SubTitleFontSize=12");
			...
			if (__ts_demand_override_monthly_JCheckBox.isSelected() && __ts_demand_override_monthly_JCheckBox.isEnabled())
			{
			...
			if (__ts_water_right_monthly_JCheckBox.isSelected() && __ts_water_right_monthly_JCheckBox.isEnabled())
			{
				if (div.getRights().Count > 0)
				{
					// Create a monthly time series to illustrate the water right volume...
					ts = StateMod_Util.createWaterRightTS(div, TimeInterval.MONTH, StateMod_DataSet.lookupTimeSeriesDataUnits(StateMod_DataSet.COMP_DIVERSION_TS_MONTHLY), __dataset.getDataStart(), __dataset.getDataEnd());
					if (ts != null)
					{
						props.set("Data " + sub + "." + (++its) + ".TSID=" + ts.getIdentifierString());
						tslist.Add(ts);
		...
		if (__ts_demand_ave_monthly_JCheckBox.isSelected() && __ts_demand_ave_monthly_JCheckBox.isEnabled())
		{
			...
			its = 0;
			props.set("SubProduct " + sub + ".GraphType=Line");
			props.set("SubProduct " + sub + ".SubTitleString=Monthly Average Data for Diversion " + div.getID() + " (" + div.getName() + ")");
			props.set("SubProduct " + sub + ".SubTitleFontSize=12");
		...
		if ((__ts_diversion_daily_JCheckBox.isSelected() && __ts_diversion_daily_JCheckBox.isEnabled()) || (__ts_diversion_est_daily_JCheckBox.isSelected() && __ts_diversion_est_daily_JCheckBox.isEnabled()) || (__ts_demand_daily_JCheckBox.isSelected() && __ts_demand_daily_JCheckBox.isEnabled()) || (__ts_demand_est_daily_JCheckBox.isSelected() && __ts_demand_est_daily_JCheckBox.isEnabled()) || (__ts_cwr_daily_JCheckBox.isSelected() && __ts_cwr_daily_JCheckBox.isEnabled()) || (__ts_cwr_est_daily_JCheckBox.isSelected() && __ts_cwr_est_daily_JCheckBox.isEnabled()) || (__ts_water_right_daily_JCheckBox.isSelected() && __ts_water_right_daily_JCheckBox.isEnabled()))
		{
			// Do the daily graph...
			++sub;
			its = 0;
			props.set("SubProduct " + sub + ".GraphType=Line");
			props.set("SubProduct " + sub + ".SubTitleString=Daily Data for Diversion " + div.getID() + " (" + div.getName() + ")");
			props.set("SubProduct " + sub + ".SubTitleFontSize=12");
			...
			if (__ts_diversion_est_daily_JCheckBox.isSelected() && __ts_diversion_est_daily_JCheckBox.isEnabled())
			{
				...
				dayts = null;
				if (cdividy.Equals(div.getID(), StringComparison.OrdinalIgnoreCase))
				{
				...
				else if (!cdividy.Equals("0") && !cdividy.Equals("4"))
				{
					...
					pos = TSUtil.IndexOf((System.Collections.IList)comp.getData(), cdividy, "Location", 0);
					if (pos >= 0)
					{
						dayts = (DayTS)data[pos];
					}
				}
				ts = StateMod_Util.createDailyEstimateTS(div.getID(), div.getName(), "Diversion", "CFS", cdividy, div.getDiversionMonthTS(), dayts);
				if (ts != null)
				{
					props.set("Data " + sub + "." + (++its) + ".TSID=" + ts.getIdentifierString());
					tslist.Add(ts);
			...
			if (__ts_demand_est_daily_JCheckBox.isSelected() && __ts_demand_est_daily_JCheckBox.isEnabled())
			{
				...
				ts = StateMod_Util.createDailyEstimateTS(div.getID(), div.getName(), "Demand", "CFS", cdividy, div.getDemandMonthTS(), dayts);
				if (ts != null)
				{
					props.set("Data " + sub + "." + (++its) + ".TSID=" + ts.getIdentifierString());
					tslist.Add(ts);
			...
			if (__ts_cwr_est_daily_JCheckBox.isSelected() && __ts_cwr_est_daily_JCheckBox.isEnabled())
			{
				...
				{
					// Get the daily time series from another diversion...
					comp = __dataset.getComponentForComponentType(StateMod_DataSet.COMP_CONSUMPTIVE_WATER_REQUIREMENT_TS_DAILY);
					data = (System.Collections.IList)comp.getData();
					pos = TSUtil.IndexOf((System.Collections.IList)comp.getData(), cdividy, "Location", 0);
					if (pos >= 0)
					{
				...
				ts = StateMod_Util.createDailyEstimateTS(div.getID(), div.getName(), "CWR", "CFS", cdividy, div.getDemandMonthTS(), dayts);
				if (ts != null)
				{
					props.set("Data " + sub + "." + (++its) + ".TSID=" + ts.getIdentifierString());
					tslist.Add(ts);
			...
			if (__ts_water_right_daily_JCheckBox.isSelected() && __ts_water_right_daily_JCheckBox.isEnabled())
			{
				if (div.getRights().Count > 0)
				{
					...
					ts = StateMod_Util.createWaterRightTS(div, TimeInterval.DAY, StateMod_DataSet.lookupTimeSeriesDataUnits(StateMod_DataSet.COMP_DIVERSION_TS_DAILY), __dataset.getDataStart(), __dataset.getDataEnd());
					if (ts != null)
					{
						props.set("Data " + sub + "." + (++its) + ".TSID=" + ts.getIdentifierString());
						tslist.Add(ts);
...
//		base.finalize();
	...
	{
		return __diversionsVector[__currentDiversionIndex];
	}
	...
	private void populateDiversionDailyID()
	{
		...
		IList<string> idNameVector = StateMod_Util.createIdentifierListFromStateModData(__diversionsVector, true, null);
		IList<string> static_choices = StateMod_Diversion.getCdividyChoices(true);
		// Take special care if no diversions are in the list...
		if (idNameVector.Count == 0)
		{
			idNameVector.Add(static_choices[0]);
		}
		else
		{
			idNameVector.Insert(0,static_choices[0]);
		}
		int size = static_choices.Count;
		for (int i = 1; i < size; i++)
		{
			idNameVector.Insert(i, static_choices[0]);
		}
	...
	/// <param name="index"> the index of the diversion to display on the form. </param>
	...
	*/
		...
		{
			// Default...
			Message.printWarning(2, routine, "Using default value idivsw = \"" + StateMod_Diversion.getIdivswDefault(true) + "\" because data value " + idivsw + " is unknown.");
		...
		{
			// Default...
			Message.printWarning(2, routine, "Using default value ireptype = \"" + StateMod_Diversion.getIreptypeDefault(true) + "\" because data value " + ireptype + " is unknown.");
		...
		{
			// Default...
			Message.printWarning(2, routine, "Using default value irturn = \"" + StateMod_Diversion.getIrturnDefault(true) + "\" because data value " + irturn + " is unknown.");
		...
		{
			// Default...
			Message.printWarning(2, routine, "Using default value idvcom = \"" + StateMod_Diversion.getIdvcomChoices(true) + "\" because data value " + idvcom + " is unknown.");
		...
		{
			// Default...
			Message.printWarning(2, routine, "Using default value demsrc = \"" + StateMod_Diversion.getDemsrcDefault(true) + " because data value " + demsrc + " is unknown.");
		...
		else
		{
			...
			{
				Message.printWarning(2, routine, "No dividy value matching '" + div.getID() + "' found in combo box.  Adding as Unknown.");
				s = cdividy + " - Unknown";
				// Add at the end...
		...
		if (!cdividy.Equals("3"))
		{
			...
			pos_m = TSUtil.IndexOf((System.Collections.IList)comp_m.getData(), monthid, "Location", 0);
			if (cdividy.Equals(div.getID(), StringComparison.OrdinalIgnoreCase))
			{
				...
				pos_d = TSUtil.IndexOf((System.Collections.IList)comp_d.getData(), cdividy, "Location", 0);
			}
			else
			{
		...
		{
			__ts_cwr_daily_JCheckBox.setEnabled(false);
		}
		...
		if (!cdividy.Equals("3"))
		{
			...
			// Enable if the monthly time series for this diversion is
			// available (and daily if an identifier is specified)...
			comp_m = __dataset.getComponentForComponentType(StateMod_DataSet.COMP_CONSUMPTIVE_WATER_REQUIREMENT_TS_MONTHLY);
			pos_m = TSUtil.IndexOf((System.Collections.IList)comp_m.getData(), monthid, "Location", 0);
			if (cdividy.Equals(div.getID(), StringComparison.OrdinalIgnoreCase))
			{
				// The daily time series for this diversion must also be available...
				comp_d = __dataset.getComponentForComponentType(StateMod_DataSet.COMP_CONSUMPTIVE_WATER_REQUIREMENT_TS_DAILY);
				pos_d = TSUtil.IndexOf((System.Collections.IList)comp_d.getData(), cdividy, "Location", 0);
			}
			else
			{
	...
	private bool saveCurrentDiversion()
	{
	...
	private bool saveData(int record)
	{
		...
		StateMod_Diversion div = __diversionsVector[record];
	...
	public virtual void selectID(string id)
	{
		...
		for (int i = 0; i < rows; i++)
		{
			...
			if (div.getID().Equals(id, StringComparison.OrdinalIgnoreCase))
			{
				// REVISIT - how to handle the last parameter...
	...
	private void setupGUI(int index)
	{
		...
		JGUIUtil.addComponent(left_JPanel, jsw, 0, 0, 1, 5, 1, 1, GridBagConstraints.BOTH, GridBagConstraints.NORTHWEST);
		...
		JGUIUtil.addComponent(search_JPanel, __findNextDiv_JButton, 1, ++y, 2, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.WEST);

		JGUIUtil.addComponent(left_JPanel, search_JPanel, 0, 5, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.WEST);
		...
		y = 0;
		JGUIUtil.addComponent(param_JPanel, new JLabel("Diversion ID:"), 0, y, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.EAST);
		__diversionStationID_JTextField = new JTextField(12);
		__diversionStationID_JTextField.setEditable(false);
		__diversionStationID_JTextField.setToolTipText("<HTML>The diversion ID is the primary identifier for the diversion.<BR>" + "The ID is used to relate data in various data files.</HTML>");
		JGUIUtil.addComponent(param_JPanel, __diversionStationID_JTextField, 1, y, 2, 1, 0, 0, 1, 0, 0, 1, GridBagConstraints.NONE, GridBagConstraints.WEST);

		JGUIUtil.addComponent(param_JPanel, new JLabel("Diversion name:"), 0, ++y, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.EAST);
		__diversionName_JTextField = new JTextField(24);
		__diversionName_JTextField.setToolTipText("<HTML>The diversion name is used for labels and output.</HTML>");
		JGUIUtil.addComponent(param_JPanel, __diversionName_JTextField, 1, y, 2, 1, 0, 0, 1, 0, 0, 1, GridBagConstraints.NONE, GridBagConstraints.WEST);
		...
		__riverNodeID_JTextField.setToolTipText("<HTML>The river node is used in the network file.<BR>" + "In most cases the river node ID is the same as the diversion " + "ID,<BR>although StateMod internally uses two identifiers.</HTML>");
		...
		JGUIUtil.addComponent(param_JPanel, new JLabel("Capacity (CFS):"), 0, ++y, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.EAST);
		__diversionCapacity_JTextField = new JTextField(11);
		__diversionCapacity_JTextField.setToolTipText("<HTML>The capacity is a physical limit above which water cannot be diverted.</HTML>");
		JGUIUtil.addComponent(param_JPanel, __diversionCapacity_JTextField, 1, y, 2, 1, 0, 0, 1, 0, 0, 1, GridBagConstraints.NONE, GridBagConstraints.WEST);
		...
		__diversionSwitch_JComboBox.setToolTipText("<HTML>The on/off switch tells StateMod whether to include the diversion in the analysis.</HTML>");
		JGUIUtil.addComponent(param_JPanel, __diversionSwitch_JComboBox, 1, y, 2, 1, 0, 0, 1, 0, 0, 1, GridBagConstraints.HORIZONTAL, GridBagConstraints.WEST);

		JGUIUtil.addComponent(param_JPanel, new JLabel("User name:"), 0, ++y, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.EAST);
		__userName_JTextField = new JTextField(24);
		__userName_JTextField.setToolTipText("<HTML>The user name is the owner for the ditch and is often set to the diversion name.</HTML>");
		JGUIUtil.addComponent(param_JPanel, __userName_JTextField, 1, y, 2, 1, 0, 0, 1, 0, 0, 1, GridBagConstraints.NONE, GridBagConstraints.WEST);

		JGUIUtil.addComponent(param_JPanel, new JLabel("Replacement reservoir:"), 0, ++y, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.EAST);
		__replacementReservoirOption_JComboBox = new SimpleJComboBox();
		__replacementReservoirOption_JComboBox.addActionListener(this);
		__replacementReservoirOption_JComboBox.setData(StateMod_Diversion.getIreptypeChoices(true));
		__replacementReservoirOption_JComboBox.setToolTipText("<HTML>Used with operational right type 10 (Replacement Reservoir) (see operational rights data).</HTML>");
		JGUIUtil.addComponent(param_JPanel, __replacementReservoirOption_JComboBox, 1, y, 2, 1, 0, 0, 1, 0, 0, 1, GridBagConstraints.HORIZONTAL, GridBagConstraints.WEST);

		JGUIUtil.addComponent(param_JPanel, new JLabel("Use type:"), 0, ++y, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.EAST);
		...
		__useType_JComboBox.setToolTipText("<HTML>The use type indicates how the diverted water will be used.</HTML>");
		JGUIUtil.addComponent(param_JPanel, __useType_JComboBox, 1, y, 2, 1, 0, 0, 1, 0, 0, 1, GridBagConstraints.HORIZONTAL, GridBagConstraints.WEST);

		JGUIUtil.addComponent(param_JPanel, new JLabel("Irrigated acreage:"), 0, ++y, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.EAST);
		__irrigatedAcreage_JTextField = new JTextField(8);
		__irrigatedAcreage_JTextField.setToolTipText("<HTML>The irrigated acreage is an estimate of current " + "acreage and is not used by StateMod.</HTML>");
		JGUIUtil.addComponent(param_JPanel, __irrigatedAcreage_JTextField, 1, y, 2, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.WEST);

		JGUIUtil.addComponent(param_JPanel, new JLabel("Monthly demand type:"), 0, ++y, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.EAST);
		...
		__demandType_JComboBox.setToolTipText("<HTML>The monthly demand type indicates which " + " time series should be used for monthly demands.</HTML>");
		JGUIUtil.addComponent(param_JPanel, __demandType_JComboBox, 1, y, 2, 1, 0, 0, GridBagConstraints.HORIZONTAL, GridBagConstraints.WEST);

		// May be able to phase this out...
		JGUIUtil.addComponent(param_JPanel, new JLabel("Demand source:"), 0, ++y, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.EAST);
		...
		__demandSource_JComboBox.setToolTipText("<HTML>The demand source is not used by StateMod.<BR>" + "It is used by CDSS DMI software to automate data processing.</HTML>");
		JGUIUtil.addComponent(param_JPanel, __demandSource_JComboBox, 1, y, 2, 1, 0, 0, 1, 0, 0, 1, GridBagConstraints.HORIZONTAL, GridBagConstraints.WEST);

		JGUIUtil.addComponent(param_JPanel, new JLabel("Daily data ID:"), 0, ++y, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.EAST);
		__diversionDailyID_JComboBox = new SimpleJComboBox();
		__diversionDailyID_JComboBox.setToolTipText("<HTML>The daily ID is used with a daily time step (see control data).<BR>" + "Specify 3 if daily time series are available for the diversion.<BR>" + "All other cases use the monthly amount distributed to daily.</HTML>");
		JGUIUtil.addComponent(param_JPanel, __diversionDailyID_JComboBox, 1, y, 2, 1, 0, 0, 1, 0, 0, 1, GridBagConstraints.HORIZONTAL, GridBagConstraints.WEST);

		JGUIUtil.addComponent(param_JPanel, new JLabel("Available water content (AWC):"), 0, ++y, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.EAST);
		__awc_JTextField = new JTextField(12);
		__awc_JTextField.setToolTipText("<HTML>Available water content (AWC) is used only when<BR>" + "soil moisture is considered (see control data).</HTML>");
		JGUIUtil.addComponent(param_JPanel, __awc_JTextField, 1, y, 2, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.WEST);

		JGUIUtil.addComponent(right_JPanel,param_JPanel, 0, 0, 11, 5, 0, 0, GridBagConstraints.HORIZONTAL, GridBagConstraints.WEST);
		...
		__effConstant_JRadioButton.setToolTipText("<HTML>A constant efficiency is used if monthly or variable efficiencies are not specified.</HTML>");
		effButtonGroup.add(__effConstant_JRadioButton);
		JGUIUtil.addComponent(eff_JPanel, __effConstant_JRadioButton, 0, 0, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.WEST);
		__effConstant_JTextField = new JTextField(4);
		__effConstant_JTextField.setToolTipText("<HTML>A constant efficiency is used if monthly or variable " + "efficiencies are not specified.</HTML>");
		JGUIUtil.addComponent(eff_JPanel, __effConstant_JTextField, 1, 0, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.WEST);

		__effMonthly_JRadioButton = new JRadioButton("Monthly efficiency  ", false);
		__effMonthly_JRadioButton.addActionListener(this);
		__effMonthly_JRadioButton.setToolTipText("<HTML>Monthly efficiencies are used if variable efficiencies are not used<BR>" + "(see variable effiency control data).</HTML>");
		effButtonGroup.add(__effMonthly_JRadioButton);
		JGUIUtil.addComponent(eff_JPanel, __effMonthly_JRadioButton, 0, 1, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.WEST);
		...
		for (int i = 0; i < 12; i++)
		{
			...
			__effMonthly_JTextField[i].setToolTipText("<HTML>Monthly efficiencies are used if variable efficiencies are not used<BR>" + "(see variable effiency control data).</HTML>");
		}
		...
		{
			JGUIUtil.addComponent(moneff_JPanel, new JLabel("Oct"), x, y, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.CENTER);
			JGUIUtil.addComponent(moneff_JPanel, new JLabel("Nov"), ++x, y, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.CENTER);
			JGUIUtil.addComponent(moneff_JPanel, new JLabel("Dec"), ++x, y, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.CENTER);
			JGUIUtil.addComponent(moneff_JPanel, new JLabel("Jan"), ++x, y, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.CENTER);
			JGUIUtil.addComponent(moneff_JPanel, new JLabel("Feb"), ++x, y, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.CENTER);
			JGUIUtil.addComponent(moneff_JPanel, new JLabel("Mar"), ++x, y, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.CENTER);
		}
		else if (__dataset.getCyrl() == YearType.NOV_TO_OCT)
		{
			...
			JGUIUtil.addComponent(moneff_JPanel, new JLabel("Feb"), ++x, y, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.CENTER);
			JGUIUtil.addComponent(moneff_JPanel, new JLabel("Mar"), ++x, y, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.CENTER);
			JGUIUtil.addComponent(moneff_JPanel, new JLabel("Apr"), ++x, y, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.CENTER);
		}
		else
		{
			JGUIUtil.addComponent(moneff_JPanel, new JLabel("Jan"), x, y, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.CENTER);
			...
			JGUIUtil.addComponent(moneff_JPanel, new JLabel("Mar"), ++x, y, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.CENTER);
			JGUIUtil.addComponent(moneff_JPanel, new JLabel("Apr"), ++x, y, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.CENTER);
			JGUIUtil.addComponent(moneff_JPanel, new JLabel("May"), ++x, y, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.CENTER);
			JGUIUtil.addComponent(moneff_JPanel, new JLabel("Jun"), ++x, y, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.CENTER);
		}
		...
		for (int i = 0; i < 6; i++)
		{
			JGUIUtil.addComponent(moneff_JPanel, __effMonthly_JTextField[i], ++x, y, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.WEST);
		}
		if (__dataset.getCyrl() == YearType.WATER)
		{
			++y;
			...
			JGUIUtil.addComponent(moneff_JPanel, new JLabel("May"), ++x, y, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.CENTER);
			JGUIUtil.addComponent(moneff_JPanel, new JLabel("Jun"), ++x, y, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.CENTER);
			JGUIUtil.addComponent(moneff_JPanel, new JLabel("Jul"), ++x, y, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.CENTER);
			JGUIUtil.addComponent(moneff_JPanel, new JLabel("Aug"), ++x, y, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.CENTER);
			JGUIUtil.addComponent(moneff_JPanel, new JLabel("Sep"), ++x, y, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.CENTER);
		}
		else if (__dataset.getCyrl() == YearType.NOV_TO_OCT)
		{
			JGUIUtil.addComponent(moneff_JPanel, new JLabel("May"), ++x, y, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.CENTER);
		...
		JGUIUtil.addComponent(eff_JPanel, moneff_JPanel, 1, 1, 6, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.CENTER);
		JGUIUtil.addComponent(middle_JPanel, eff_JPanel, 0, 0, 2, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.CENTER);
		...
		__returnFlow_JButton.setToolTipText("<HTML>Assign return flow locations and specify<BR>" + "delay tables for the return pattern.</HTML>");
		JGUIUtil.addComponent(relatedData_JPanel, __returnFlow_JButton, 0, y2, 4, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.WEST);
		__waterRights_JButton = new SimpleJButton("Water Rights...", this);
		__waterRights_JButton.setToolTipText("<HTML>View/edit water rights for this diversion.</HTML>");
		JGUIUtil.addComponent(relatedData_JPanel, __waterRights_JButton, 0, ++y2, 4, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.WEST);
		//JGUIUtil.addComponent(right_JPanel, relatedData_JPanel, 
		//	8, 5, 2, 2, 0, 0, 
		//	GridBagConstraints.NONE, GridBagConstraints.WEST);
		JGUIUtil.addComponent(middle_JPanel, relatedData_JPanel, 2, 0, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.WEST);

		// Now add the middle panel to the right side of the main panel...
		JGUIUtil.addComponent(right_JPanel, middle_JPanel, 0, 5, 8, 2, 0, 0, GridBagConstraints.NONE, GridBagConstraints.WEST);
		...
		__ts_diversion_monthly_JCheckBox.setToolTipText("<HTML>The diversion time series is used to estimate base " + "(naturalized) flows and for reports.</HTML>");
		JGUIUtil.addComponent(ts_JPanel, __ts_diversion_monthly_JCheckBox, x, y2, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.WEST);
		...
		__ts_diversion_daily_JCheckBox.setToolTipText("<HTML>The diversion time series is used to estimate base " + "(naturalized) flows and for reports.</HTML>");
		JGUIUtil.addComponent(ts_JPanel, __ts_diversion_daily_JCheckBox, x, ++y2, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.WEST);

		__ts_diversion_est_daily_JCheckBox = new JCheckBox("Historical Diversion, Estimated (Daily)");
		__ts_diversion_est_daily_JCheckBox.addItemListener(this);
		__ts_diversion_est_daily_JCheckBox.setToolTipText("<HTML>This time series is calculated from other data " + "based on the Daily Data ID.<BR>" + "StateMod will compute the time series at run time.<BR>" + "If available here, it is for information only and cannot be edited.</HTML>");
		JGUIUtil.addComponent(ts_JPanel, __ts_diversion_est_daily_JCheckBox, x, ++y2, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.WEST);

		__ts_water_right_monthly_JCheckBox = new JCheckBox("Water Right (Monthly)");
		__ts_water_right_monthly_JCheckBox.addItemListener(this);
		__ts_water_right_monthly_JCheckBox.setToolTipText("<HTML>The total water rights can be graphed as a constant." + "<BR>The rights in CFS are constant but AF/M vary." + "<BR>This indicates a legal right to water.</HTML>");
		JGUIUtil.addComponent(ts_JPanel, __ts_water_right_monthly_JCheckBox, x, ++y2, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.WEST);

		__ts_water_right_daily_JCheckBox = new JCheckBox("Water Right (Daily)");
		__ts_water_right_daily_JCheckBox.addItemListener(this);
		__ts_water_right_daily_JCheckBox.setToolTipText("<HTML>The total water rights can be graphed as a constant." + "<BR>The rights in CFS are constant but AF/M vary." + "<BR>This indicates a legal right to water.</HTML>");
		JGUIUtil.addComponent(ts_JPanel, __ts_water_right_daily_JCheckBox, x, ++y2, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.WEST);

		y2 = 0;
		__ts_demand_monthly_JCheckBox = new JCheckBox("Demands (Monthly)");
		__ts_demand_monthly_JCheckBox.addItemListener(this);
		__ts_demand_monthly_JCheckBox.setToolTipText("<HTML>This demand time series is used if the Monthly demand type is 1 or 3.</HTML>");
		JGUIUtil.addComponent(ts_JPanel, __ts_demand_monthly_JCheckBox, ++x, y2, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.WEST);
		...
		__ts_demand_override_monthly_JCheckBox.setToolTipText("<HTML>This demand time series overrides the above data and is useful for scenario analysis.</HTML>");
		JGUIUtil.addComponent(ts_JPanel, __ts_demand_override_monthly_JCheckBox, x, ++y2, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.WEST);
		...
		__ts_demand_ave_monthly_JCheckBox.setToolTipText("<HTML>This demand time series is used if the Monthly" + "demand type is 2 or 4.</HTML>");
		JGUIUtil.addComponent(ts_JPanel, __ts_demand_ave_monthly_JCheckBox, x, ++y2, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.WEST);

		__ts_demand_daily_JCheckBox = new JCheckBox("Demands (Daily)");
		__ts_demand_daily_JCheckBox.addItemListener(this);
		JGUIUtil.addComponent(ts_JPanel, __ts_demand_daily_JCheckBox, x, ++y2, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.WEST);

		__ts_demand_est_daily_JCheckBox = new JCheckBox("Demands, Estimated (Daily)");
		__ts_demand_est_daily_JCheckBox.addItemListener(this);
		__ts_demand_est_daily_JCheckBox.setToolTipText("<HTML>This time series is calculated from other data based on the Daily Data ID.<BR>" + "StateMod will compute the time series at runtime.<BR>" + "If available here, it is for information only and cannot be edited.</HTML>");
		JGUIUtil.addComponent(ts_JPanel, __ts_demand_est_daily_JCheckBox, x, ++y2, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.WEST);

		y2 = 0;
		__ts_ipy_yearly_JCheckBox = new JCheckBox("Irrigation Practice (Yearly)");
		__ts_ipy_yearly_JCheckBox.addItemListener(this);
		__ts_ipy_yearly_JCheckBox.setToolTipText("<HTML>The irrigation practice data have yearly values " + "for maximum efficiency, irrigation method and acres irrigated.</HTML>");
		JGUIUtil.addComponent(ts_JPanel, __ts_ipy_yearly_JCheckBox, ++x, y2, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.WEST);
		...
		__ts_cwr_monthly_JCheckBox.setToolTipText("<HTML>This requirement time series is used in place of " + "monthly demands<BR>if the control data indicate to use variable efficiency.</HTML>");
		JGUIUtil.addComponent(ts_JPanel, __ts_cwr_monthly_JCheckBox, x, ++y2, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.WEST);

		__ts_cwr_daily_JCheckBox = new JCheckBox("Consumptive Water Requirement (Daily)");
		__ts_cwr_daily_JCheckBox.addItemListener(this);
		__ts_cwr_daily_JCheckBox.setToolTipText("<HTML>This requirement time series is used in place of " + "daily demands<BR>if the control data indicate to use variable efficiency.</HTML>");
		JGUIUtil.addComponent(ts_JPanel, __ts_cwr_daily_JCheckBox, x, ++y2, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.WEST);
		...
		__ts_cwr_est_daily_JCheckBox.setToolTipText("<HTML>This time series is calculated from other data based on the Daily Data ID.<BR>" + "StateMod will compute the time series at runtime.<BR>" + "If available here, it is for information only and cannot be edited.</HTML>");
		JGUIUtil.addComponent(ts_JPanel, __ts_cwr_est_daily_JCheckBox, x, ++y2, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.WEST);
		...
		JGUIUtil.addComponent(ts_JPanel, tsb_JPanel, x, ++y2, 1, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.EAST);

		JGUIUtil.addComponent(right_JPanel, ts_JPanel, 0, 7, 10, 2, 0, 0, GridBagConstraints.NONE, GridBagConstraints.WEST);
		...
		JGUIUtil.addComponent(right_JPanel, button_JPanel, 0, 9, 10, 1, 0, 0, GridBagConstraints.NONE, GridBagConstraints.SOUTHEAST);
