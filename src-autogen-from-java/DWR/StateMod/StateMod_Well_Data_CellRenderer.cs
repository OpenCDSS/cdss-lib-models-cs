...
//ORIGINAL LINE: @SuppressWarnings("serial") public class StateMod_Well_Data_CellRenderer extends RTi.Util.GUI.JWorksheet_AbstractExcelCellRenderer
	public class StateMod_Well_Data_CellRenderer : JWorksheet_AbstractExcelCellRenderer
	{
