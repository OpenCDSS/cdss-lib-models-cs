...
namespace DWR.StateMod
{
	...
	/// </summary>
	public class StateMod_Diversion_DelayTableAssignment_Data_TableModel : JWorksheet_AbstractRowTableModel
	{
	...
	public StateMod_Diversion_DelayTableAssignment_Data_TableModel(System.Collections.IList data) : this(data, true)
	{
	}
	...
	public StateMod_Diversion_DelayTableAssignment_Data_TableModel(System.Collections.IList data, bool editable)
	{
		if (data == null)
		{
